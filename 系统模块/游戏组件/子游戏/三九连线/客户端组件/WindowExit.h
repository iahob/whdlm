...
class CWindowExit : public CVirtualWindow
{
	// 变量信息
public:
	LONGLONG*						m_plPlayScore;							// 玩家积分
	LONGLONG*						m_plPlayWinLose;							// 玩家输赢分
...
public:
	...
	CVirtualButton					m_btSaveExit;							// 保存退出
	CVirtualButton					m_btNoSaveExit;							// 不保存退出
...
public:
	// 设置积分
	void SetOverInfo( LONGLONG* plPlayScore, LONGLONG* plPlayWinLose ) { m_plPlayScore = plPlayScore; m_plPlayWinLose = plPlayWinLose; }
