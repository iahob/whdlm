...
IMPLEMENT_DYNAMIC(CDialogDexter, CDialog)
...
// 构造函数
CDialogDexter::CDialogDexter(UINT nIDTemplate, int nShowMax, CServerConfigDlg *pParentWnd) : CDialog(nIDTemplate, pParentWnd)
{
...
void CDialogDexter::OnShowTrend()
{
}