...
protected:
	...
	USERACHIEVEMENT					m_userachievement[GAME_PLAYER];		//积分房卡个人成就
...
protected:
	...
	//服务调试
protected:
	static HINSTANCE				m_hDebugInst;
	static IServerDebug*			m_pServerDebug;
...
protected:
	...
	//调试用户
	bool OnDebugCard(IServerUserItem * pIServerUserItem);
	//发送调试信息
	void SendDebugCard();
	//断线托管
	bool IsOfflineTrustee(BYTE cbTrusteeTime = INVALID_BYTE);
	//写日志文件
