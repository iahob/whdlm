...
protected:
	...
	LONGLONG						m_lChipArray[MAX_CHIP_COUNT];		//筹码配置
    //下注数
protected:
	LONGLONG						m_lLastAllJettonPlace[GAME_PLAYER][AREA_MAX];	//上局总下注
	LONGLONG						m_lLastAllJettonArea[GAME_PLAYER][AREA_MAX];	//本局最后一次操作
...
protected:
	...
	bool OnUserRePlayBet(WORD wChairID);
    //申请庄家
...
private:
	...
	void SendContinuePlaceBetFail(WORD wChairID);
    //发送消息
