...
bool CDlgCustomRule::SaveCustomRule(LPBYTE pcbCustomRule, WORD wCustomSize)
{
	...
	if( m_hWnd )
	{
		...
		nID = IDC_EDIT_JETTON_1;
		while (nID <= IDC_EDIT_JETTON_6)
		{
			TCHAR szData[256] = { 0 };
			m_DlgCustomGeneral.GetDlgItemText(nID, szData, sizeof(szData));
...
VOID CDlgCustomGeneral::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_JETTON_1, m_CustomGeneral.lChipArray[0]);
	DDX_Text(pDX, IDC_EDIT_JETTON_2, m_CustomGeneral.lChipArray[1]);
	DDX_Text(pDX, IDC_EDIT_JETTON_3, m_CustomGeneral.lChipArray[2]);
	DDX_Text(pDX, IDC_EDIT_JETTON_4, m_CustomGeneral.lChipArray[3]);
	DDX_Text(pDX, IDC_EDIT_JETTON_5, m_CustomGeneral.lChipArray[4]);
	DDX_Text(pDX, IDC_EDIT_JETTON_6, m_CustomGeneral.lChipArray[5]);
}
