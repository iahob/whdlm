...
#define SUB_S_CONTINUE_JETTON		109									//续投
#define SUB_S_CONTINUE_JETTON_FAI	110									//续投失败
...
struct CMD_S_StatusPlay
{
	...
	//上局下注
	LONGLONG						lLastPlayBet[AREA_MAX];
	//筹码配置
	LONGLONG						lChipArray[MAX_CHIP_COUNT];
	//机器人配置
	tagCustomAndroid				CustomAndroid;						//机器人配置
...
//用户下注
struct CMD_S_ContinuePlaceBet
{
	WORD							wChairID;							//用户位置
	LONGLONG						lBetScore[AREA_MAX];				//加注数目
};

//用户下注
struct CMD_S_ContinuePlaceBetFail
{
	WORD							wChairID;							//用户位置
};
...
#define SUB_C_CONTINUE_JETTON		9									//续投
