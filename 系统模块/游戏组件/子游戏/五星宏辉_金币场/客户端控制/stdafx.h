...
#include "..\..\..\..\系统模块\客户端组件\管理工具\ClientDebug.h"
...
#pragma comment (lib,"../../../../系统模块/链接库/Ansi/ShareDebugD.lib")
#else
...
#pragma comment (lib,"../../../../系统模块/链接库/Unicode/ShareDebugD.lib")
#endif
#endif
