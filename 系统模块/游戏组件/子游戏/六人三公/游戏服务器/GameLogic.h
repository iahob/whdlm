...
#define OX_MIX_THREE_KING			11									//混三公牌型
#define OX_SMALL_THREE_KING			12									//小三公牌型
#define OX_BIG_THREE_KING			13									//大三公牌型
...
{
    CString strName = GetFileDialogPath() +	"\\SanGong.log";
...
class CGameLogic
{
    //变量定义
private:
    static BYTE						m_cbCardListData[MAX_CARD];				//扑克定义
...
public:
    ...
    //获取点数
    BYTE GetAllCardValue(BYTE cbCardData[], BYTE cbCardCount);
    //获取公牌数量
    BYTE GetFaceCardCount(BYTE cbCardData[], BYTE cbCardCount);
