...
// 	}
	...
	//AA制消耗设置
// 	for(int i = IDC_TIME_AA1;  i < IDC_TIME_AA1 + CELLSCORE_COUNT; i++)
// 	{
// 		SetDlgItemInt(i,		m_PersonalRule.personalRule[i - IDC_TIME_AA1].nExOne);
// 	}
...
// 	for(int i = IDC_TIME_AA1;  i < IDC_TIME_AA1 + CELLSCORE_COUNT; i++)
// 	{
// 		m_PersonalRule.personalRule[i - IDC_TIME_AA1].nExOne = GetDlgItemInt(i);
// 	}
