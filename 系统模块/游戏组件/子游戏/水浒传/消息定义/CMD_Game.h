...
#define GAME_NAME					TEXT("水浒传")						//游戏名字
...
#define SUB_S_TWO_GAME_CONCLUDE			104									//比倍结束
#define SUB_S_THREE_START				105									//小玛丽结束
#define SUB_S_THREE_KAI_JIAN			106									//小玛丽结束
...
#define SUB_C_TWO_MODE				1									//比倍开始
#define SUB_C_TWO_START				2									//比倍开始
#define SUB_C_THREE_START			3									//比倍开始
#define SUB_C_TWO_GIVEUP			4									//放弃比倍
#define SUB_C_THREE_END				5									//结束玛丽
