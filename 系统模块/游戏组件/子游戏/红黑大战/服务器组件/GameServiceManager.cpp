...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME	TEXT("RedBlackBattleAndroid.dll")	//组件名字
#else
#define ANDROID_SERVICE_DLL_NAME	TEXT("RedBlackBattleAndroid.dll")	//组件名字
#endif
//构造函数
CGameServiceManager::CGameServiceManager()
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("RedBlackBattle.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("RedBlackBattleServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
