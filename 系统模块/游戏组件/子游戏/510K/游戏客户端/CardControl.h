...
//间距定义
#define DEF_X_DISTANCE				23									//默认间距
#define DEF_Y_DISTANCE				20									//默认间距
#define DEF_SHOOT_DISTANCE			20									//默认间距

//间距定义
#define DEF_X_DISTANCE_SMALL		9									//默认间距
#define DEF_Y_DISTANCE_SMALL		8									//默认间距
#define DEF_SHOOT_DISTANCE_SMALL	10									//默认间距

#define DEF_X_DISTANCE_BANKER_CARD	25									//底牌间距
