...
//机器定义
#ifndef _DEBUG
#define ANDROID_SERVICE_DLL_NAME	TEXT("ThreeMadnessAndroid.dll")	//组件名字
#else
#define ANDROID_SERVICE_DLL_NAME	TEXT("ThreeMadnessAndroid.dll")	//组件名字
#endif
...
CGameServiceManager::CGameServiceManager()
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("ThreeMadness.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("ThreeMadnessServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
bool CGameServiceManager::DefaultCustomRule(LPBYTE pcbCustomRule, WORD wCustonSize)
{
	...
	pCustomRule->nButtonValue1[0] = 2;
	pCustomRule->nButtonValue1[1] = 5;
	pCustomRule->nButtonValue1[2] = 8;
	pCustomRule->nButtonValue1[3] = 10;

	pCustomRule->nButtonValue2[0] = 4;
	pCustomRule->nButtonValue2[1] = 8;
	pCustomRule->nButtonValue2[2] = 10;
	pCustomRule->nButtonValue2[3] = 15;

	pCustomRule->nButtonValue3[0] = 5;
	pCustomRule->nButtonValue3[1] = 10;
	pCustomRule->nButtonValue3[2] = 15;
	pCustomRule->nButtonValue3[3] = 20;

	pCustomRule->nMinAllinTurnCount = 3;
	return true;
}
