...
bool CDlgCustomRule::SaveCustomRule(LPBYTE pcbCustomRule, WORD wCustomSize)
{
	...
	if (m_DlgCustomGeneral.m_CustomGeneral.cbFreeTime<3||m_DlgCustomGeneral.m_CustomGeneral.cbFreeTime>99)
	{
           AfxMessageBox(L"[空闲时间]输入范围为3-99");
			    return false;
	}
	...
	if (m_DlgCustomGeneral.m_CustomGeneral.cbEndTime<18||m_DlgCustomGeneral.m_CustomGeneral.cbEndTime>99)
	{
 AfxMessageBox(L"[结束时间]输入范围为18-99");
	 return false;
	}
...
VOID CDlgCustomGeneral::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_JETTON_1, m_CustomGeneral.BetScore[0]);
	DDX_Text(pDX, IDC_JETTON_2, m_CustomGeneral.BetScore[1]);
	DDX_Text(pDX, IDC_JETTON_3, m_CustomGeneral.BetScore[2]);
	DDX_Text(pDX, IDC_JETTON_4, m_CustomGeneral.BetScore[3]);
	DDX_Text(pDX, IDC_JETTON_5, m_CustomGeneral.BetScore[4]);
	DDX_Text(pDX, IDC_JETTON_6, m_CustomGeneral.BetScore[5]);
	DDX_Text(pDX, IDC_JETTON_7, m_CustomGeneral.BetScore[6]);
