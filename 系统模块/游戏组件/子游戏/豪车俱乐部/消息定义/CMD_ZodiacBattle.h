...
struct tagRobotInfo
{
	...
	tagRobotInfo()
	{
		int nTmpChip[7] = {500,1000,3000,5000,10000,50000,100000};
...
#define SUB_S_SEND_USER_BET_INFO    115									//发送下注
//更新库存
...
struct CMD_S_SendUserBetInfo
{
	...
	LONG							lUserJettonScore[AREA_ALL+1][GAME_PLAYER];	//个人总注
};
...
struct tagCustomAndroid
{
	...
	void DefaultCustomRule()
	{
		...
		lRobotBetMinCount = 4;
		lRobotBetMaxCount = 8;
		lRobotAreaLimit = 3000;

		lRobotScoreMin = 20000;
		lRobotScoreMax = 100000;
		lRobotBankGetMin = 20000;
		lRobotBankGetMax = 100000;
		lRobotBankGetBankerMin = 50000;
		lRobotBankGetBankerMax = 200000;
		lRobotBankStoMul = 50;
	}
};
//////////////////////////////////////////////////////////////////////////
...
#define SUB_C_UPDATE_STORAGE        17									//更新库存
