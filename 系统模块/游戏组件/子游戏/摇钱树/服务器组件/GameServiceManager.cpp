...
CGameServiceManager::CGameServiceManager()
{
	...
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT("QPFishYQSDB"),CountArray(m_GameServiceAttrib.szDataBaseName));
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("FishYQS.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("FishYQSServer.dll"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
VOID * CGameServiceManager::CreateAndroidUserItemSink(REFGUID Guid, DWORD dwQueryVer)
{
	try
	{
		...
		{
			m_AndroidServiceHelper.SetModuleCreateInfo( _T("FishYQSAndroidService.dll"), "CreateGameServiceManager" );
