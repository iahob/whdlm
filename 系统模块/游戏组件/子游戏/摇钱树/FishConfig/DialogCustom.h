...
public:
	...
	virtual void DoDataExchange(CDataExchange* pDX)
	{
		...
		DDX_Text(pDX, IDC_EDIT_FIS_73, g_CustomRule.nCatchFishMultiple[24][0]);
		DDX_Text(pDX, IDC_EDIT_FIS_74, g_CustomRule.nCatchFishMultiple[24][1]);
		...
		DDX_Text(pDX, IDC_EDIT_FIS_75, g_CustomRule.nCatchFishDifficult[24]);
	}
};
