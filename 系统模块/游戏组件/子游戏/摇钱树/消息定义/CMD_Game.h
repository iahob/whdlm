...
// 公共宏定义
#define KIND_ID						511								// 游戏 I D
#define GAME_NAME					TEXT("摇钱树")				// 游戏名字
...
enum EnumFishType
{
	...
	FishType_JinLong			= 18,							// 金龙
	FishType_LvGuiYQS			= 19,							// 绿龟摇钱树
	FishType_YinGuiYQS			= 20,							// 银龟摇钱树
	FishType_JinGuiYQS			= 21,							// 金龟摇钱树
	FishType_ShuiHuZhuan		= 22,							// 水浒传
	FishType_ZhongYiTang		= 23,							// 忠义堂
	FishType_BaoZhaFeiBiao		= 24,							// 爆炸飞镖
	FishType_BaoXiang			= 25,							// 宝箱
	FishType_YuanBao			= 26,							// 元宝鱼
	FishType_General_Max		= 22,							// 普通鱼最大
	FishType_Normal_Max			= 25,							// 正常鱼最大
	FishType_Max				= 27,							// 最大数量
	FishType_Small_Max			= 9,							// 小鱼最大索引
	FishType_Moderate_Max		= 15,							// 中鱼索
	FishType_Moderate_Big_Max	= 18,							// 中大鱼索
	FishType_Big_Max			= 25,							// 大鱼索引
