...
#define KIND_ID						143									//游戏 I D
#define GAME_PLAYER					MAX_CHAIR									//游戏人数
#define GAME_NAME					TEXT("百人推筒子")					//游戏名字
...
//区域索引
#define ID_TIAN_MEN					1									//天门
#define ID_ZHONG_MEN				2									//中门
#define ID_DI_MEN					3									//下门
#define AREA_MAX                    3                                   //最大索引

//玩家索引
#define BANKER_INDEX				0									//庄家索引
#define TIAN_MEN_INDEX				1									//上门索引
#define ZHONG_MEN_INDEX				2									//天门索引
#define DI_MEN_INDEX				3									//下门索引
#define MAX_INDEX					3									//最大索引
#define AREA_COUNT					3									//区域数目
#define CONTROL_AREA				3									//受控区域
//赔率定义
#define RATE_TWO_PAIR				4									//对子赔率
#define RATE_TWO_EIGHT				3									//二八
#define RATE_POINT					2									//8点  9点
#define RATE_NULL					1									//普通牌型

#define SERVER_LEN					32									//房间长度
#define MAX_CARD					2
#define MAX_CARDGROUP				4

#define RECORD_LEN					4									//记录长度
...
struct tagRobotInfo
{
	...
	tagRobotInfo()
	{
		int nTmpChip[7] = {10,100, 1000, 10000, 100000, 1000000, 10000000};
		int nTmpAreaChance[AREA_COUNT] = {2, 1, 1};
...
{
	BYTE							bPointBanker;						//庄家点数
	BYTE							bWinTianMen;						//天门点数
	BYTE							bWinZhongMen;							//中门点数
	BYTE							bWinXiaMen;							//地门点数
};
...
#define SUB_S_SELECT_CARD_MODE		110									//发牌模式
#define SUB_S_RE_DISPATCH_CARD		111									//重新发牌
#define SUB_S_CATCH_BANKER			112									//玩家抢庄
#define SUB_S_AMDIN_COMMAND			113									//管理员命令
...
struct CMD_S_CatchBanker
{
	WORD                            wCatchUser;							//抢庄玩家
};
...
struct CMD_S_GameEnd
{
	...
	LONGLONG						lServerFees;						//游戏服务费
};

//发牌模式
struct CMD_S_SelectCardMode
{
	BYTE							cbPutCardMode;                      //摆牌模式
	BYTE                            cbSendCardMode;                     //发牌模式
};
...
#define SUB_C_CATCH_BANKER			5									//申请抢庄
#define SUB_C_SELECT_CARD_MODE		6									//发牌模式
#define SUB_C_REDISPATCH_CARD       7                                   //重新洗牌
#define SUB_C_AMDIN_COMMAND			8									//管理员命令
