...
public:
	...
	virtual IGUIJetton*	addJetton(const core::rect<s32>& rectangle, IGUIElement* parent=0, s32 id=-1);

	virtual IGUISlideImages* addSlideImages(const core::rect<s32>& rectangle, IGUIElement* parent=0, s32 id=-1);

	virtual IGUIImageButton* addImageButton(const core::rect<s32>& rectangle, IGUIElement* parent=0, s32 id=-1);

	virtual IGUIPanel*	addPanel(const core::rect<s32>& rectangle, IGUIElement* parent=0, s32 id=-1);

	virtual IGUIRecord*	addRecord(const core::rect<s32>& rectangle, IGUIElement* parent=0, s32 id=-1);
