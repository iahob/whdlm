...
IGUIJetton*	CGUIEnvironment::addJetton(const core::rect<s32>& rectangle, IGUIElement* parent, s32 id)
{
	CGUIJetton* b = new CGUIJetton(this, parent ? parent : this, id, rectangle);
	b->drop();
	return b;
}

IGUISlideImages* CGUIEnvironment::addSlideImages(const core::rect<s32>& rectangle, IGUIElement* parent, s32 id)
{
	CGUISlideImages* b = new CGUISlideImages(this, parent ? parent : this, id, rectangle);
	b->drop();
	return b;
}

IGUIImageButton* CGUIEnvironment::addImageButton(const core::rect<s32>& rectangle, IGUIElement* parent, s32 id)
{
	IGUIImageButton* b = new CGUIImageButton(this, parent ? parent : this, id, rectangle);
	b->drop();
	return b;
}

IGUIPanel*	CGUIEnvironment::addPanel(const core::rect<s32>& rectangle, IGUIElement* parent, s32 id)
{
	IGUIPanel* b = new CGUIPanel(this, parent ? parent : this, id, rectangle);
	b->drop();
	return b;
}

IGUIRecord*	CGUIEnvironment::addRecord(const core::rect<s32>& rectangle, IGUIElement* parent, s32 id)
{
	IGUIRecord* b = new CGUIRecord(this, parent ? parent : this, id, rectangle);
	b->drop();
	return b;
}
