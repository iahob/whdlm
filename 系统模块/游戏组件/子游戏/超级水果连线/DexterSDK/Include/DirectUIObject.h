...
// 控件消息
#define DEBUG_MESSAGE_ID(DebugID, MessageID)	(((__int64)DebugID << 32) + MessageID)
...
#define WHDUI_DEBUG_MESSAGE( DebugID, MessageID, MessageType, MessageFunctionType, MessageFunction )				\
{																									\
	static dex::DirectUIMessageInfo Message = { MessageType,	(dex::DirectUIMessage)static_cast<MessageFunctionType>(&ThisClass::MessageFunction) };	\
	m_MapDirectDebugMessage.SetAt( DEBUG_MESSAGE_ID(DebugID, MessageID), &Message );												\
}
...
// 控件内容
#define ON_WHDUI_DEBUG_MESSAGE( DebugID, MessageID, MessageFunction )				WHDUI_DEBUG_MESSAGE(DebugID, MessageID, dex::DirectUIMessage_VoidVoid, void (dex::CDirectUIObject::*)(void), MessageFunction)
#define ON_WHDUI_DEBUG_MESSAGE_VOID_VOID( DebugID, MessageID, MessageFunction )		WHDUI_DEBUG_MESSAGE(DebugID, MessageID, dex::DirectUIMessage_VoidVoid, void (dex::CDirectUIObject::*)(void), MessageFunction)
#define ON_WHDUI_DEBUG_MESSAGE_BOOL_VOID( DebugID, MessageID, MessageFunction )		WHDUI_DEBUG_MESSAGE(DebugID, MessageID, dex::DirectUIMessage_BoolVoid, bool (dex::CDirectUIObject::*)(void), MessageFunction)
#define ON_WHDUI_DEBUG_MESSAGE_VOID_POINTER( DebugID, MessageID, MessageFunction )	WHDUI_DEBUG_MESSAGE(DebugID, MessageID, dex::DirectUIMessage_VoidPointer, void (dex::CDirectUIObject::*)(void*), MessageFunction)
...
#define ON_CONRTOL_BN_CLICKED( DebugID, MessageFunction )	 ON_WHDUI_DEBUG_MESSAGE(DebugID, dex::WHDUI_BN_CLICKED, MessageFunction)

// 输入回车消息 void MessageFunction(void);
#define ON_CONRTOL_EN_ENTER( DebugID, MessageFunction )	 ON_WHDUI_DEBUG_MESSAGE(DebugID, dex::WHDUI_EN_ENTER, MessageFunction)

// 输入改变消息 void MessageFunction(void);
#define ON_CONRTOL_EN_CHANGE( DebugID, MessageFunction )	 ON_WHDUI_DEBUG_MESSAGE(DebugID, dex::WHDUI_EN_CHANGE, MessageFunction)
...
protected:
	...
	CMapDirectUIMessage				m_MapDirectDebugMessage;
