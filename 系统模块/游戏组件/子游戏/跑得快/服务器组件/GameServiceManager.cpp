...
CGameServiceManager::CGameServiceManager()
{
	...
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT("QPRunFastDB"),CountArray(m_GameServiceAttrib.szDataBaseName));
	lstrcpyn(m_GameServiceAttrib.szClientEXEName,TEXT("RunFast.EXE"),CountArray(m_GameServiceAttrib.szClientEXEName));
	lstrcpyn(m_GameServiceAttrib.szServerDLLName,TEXT("RunFastServer.DLL"),CountArray(m_GameServiceAttrib.szServerDLLName));
...
// 	pCustomRule->cbTimeShowCard=10;
	...
	pCustomRule->wPlayerCount	= GAME_PLAYER;
	pCustomRule->bSixTheenCard  = true;
	pCustomRule->bNoForceClose  = false;
	pCustomRule->bNoRemoveBomb  = false;
	pCustomRule->bSpadeBanker	= true;
	pCustomRule->bForceOutCard = true;
	pCustomRule->bEchelonConclude = false;
	pCustomRule->cbTrusteeDelayTime = 5;
	pCustomRule->DefaultTimeConfig();
