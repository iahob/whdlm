...
#define SR_ALLOW_AVERT_DEBUG_MODE	0x00000040							//隐藏信息
...
#define SR_SUPORT_GROUP				0x08000000							//支持大联盟
...
public:
	...
	//隐藏信息
	static bool IsAllowAvertDebugMode(DWORD dwServerRule) { return (dwServerRule&SR_ALLOW_AVERT_DEBUG_MODE)!=0; }
...
public:
	...
	//隐藏信息
	static VOID SetAllowAvertDebugMode(DWORD & dwServerRule, bool bEnable) { (bEnable==true)?dwServerRule|=SR_ALLOW_AVERT_DEBUG_MODE:dwServerRule&=~SR_ALLOW_AVERT_DEBUG_MODE; }
...
public:
	...
	//支持大联盟
	static bool IsSuportGroup(DWORD dwServerRule) { return (dwServerRule&SR_SUPORT_GROUP) != 0; }
	//支持手机
	...
	//支持大联盟
	static VOID SetSuportGroup(DWORD& dwServerRule, bool bEnable) { (bEnable == true) ? dwServerRule |= SR_SUPORT_GROUP : dwServerRule &= ~SR_SUPORT_GROUP; }
