...
protected:
	...
	tagGameServerLevelInfo * 			m_pGameServerLevelInfo;				//等级配置
...
protected:
	...
	//选择改变
	VOID OnSelchangeServerLevel();

	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedRevenueRadio();
	afx_msg void OnBnClickedServiceScoreRadio();

	//单击入场比例(底分*N%)
	afx_msg void OnBnClickedServiceRatioRadio();
...
protected:
	...
	tagPersonalRoomOption *		m_pPersonalRoomOption;			//私人房配置
	tagPersonalRoomOptionRightAndFee * m_pCreateRoomRightAndFee;//权限与费用配置
	tagGameServerLevelInfo 			m_GameServerLevelInfo;				//等级配置
...
private:
	...
	//加载等级
	bool LoadDBGameServerLevelItem();
