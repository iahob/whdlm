...
#define MAX_ROOMCHAIR				512									//最大房间椅子
#define MAX_TABLE					512									//最大桌子
#define MAX_COLUMN					64									//最大列表
#define MAX_BATCH					1									//最大批次
#define MAX_ANDROID					2048								//最大机器
#define MAX_PROPERTY				128									//最大道具
#define MAX_WHISPER_USER			16									//最大私聊
#define MAX_BUFF					10									//最大Buff
#define MAX_GAMESERVER_LEVEL		32									//最大房间等级
#define MAX_GAMECHAT				64									//最大聊天
#define MAX_CHATSTRINGLEN			128									//最大聊天字符串长度
#define MAX_SHARESTORAGEITEM		256									//最大共享库存子项
...
#define PRIME_ANDROID_USER			503L								//AI数
...
#define LEN_GROUP_INTRODUCE			64									//群组介绍
...
#define LEN_CHECK_CODE				7									//验证码长度
#define LEN_BANKEROP_BT				5									//银行存取操作按钮
#define LEN_SUB_RESERVED_BUFFER		256									//子项预留
...
#define	DAY_SECONDS						(24*60*60)							//每日秒数
#define	HOUR_SECONDS					(60*60)								//小时秒数
...
//用户状态
#define US_GP_OFFLINE				0x00								//离线状态	
#define US_GP_ONLINE				0x01								//在线状态
...
//报名模式
#define SIGNUP_MODE_SIGNUP_FEE		0x01								//报名费用
#define SIGNUP_MODE_MATCH_USER		0x02								//特定比赛
...
//长度定义
#define MAX_MATCH_ROUNDS			10									//最大轮数
#define MAX_MATCH_SECTION			10									//最大阶段
//////////////////////////////////////////////////////////////////////////////////
...
#define UD_ONLINE_TIME				52									//AI在线时长
#define UD_CARRY_GRADE				53									//AI携带等级
#define UD_LEAVE_GRADE				54									//AI离开等级
...
const int GOLD_TURN_COUNT = 10000000;									//约战金币局数

//最大语音
#define MAXT_VOICE_LENGTH				15000							//语音长度
#define MAXT_H5_VOICE_LENGTH			256								//语音长度
//视频相关
...
//俱乐部相关
#define GROUP_ID_ARRAY_LEN	512		//俱乐部id长度
#define GROUP_MAX_CHAIR_GAME_TABLE_COUNT	10												//大联盟百人游戏桌子数
#define GROUP_MAX_CHAIR_GAME_CHAIR_COUNT	MAX_CHAIR / GROUP_MAX_CHAIR_GAME_TABLE_COUNT	//大联盟百人游戏椅子数(最大游戏椅子数)
const int PERSONAL_ROOM_CHAIR = GROUP_MAX_CHAIR_GAME_CHAIR_COUNT;		//私人房间座子上椅子的最大数目

//////////////////////////////////////////////////////////////////////////
//俱乐部定义
#define GP_SOCKET_PACKET			8192								//数据长度
#define GS_GROUP_COUNT				20000								//群组数目

//更新类型
#define UPGROUP_KIND_WEALTH			0x01								//财富类型
#define UPGROUP_KIND_PROPERTY		0x02								//属性类型
#define UPGROUP_KIND_BATTLERULE		0x04								//规则类型

//更新类型
#define UPMEMBER_KIND_BATTLE		1									//约战类型
