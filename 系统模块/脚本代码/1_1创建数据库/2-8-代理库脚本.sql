...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'返利类型（1：充值返利【钻石】、2：游戏服务比例返利【金币】）' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ReturnAwardConfig', @level2type=N'COLUMN',@level2name=N'AwardType'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'转赠类型： 同返利类型 1：充值返利【钻石】 2：游戏服务比例返利【金币】' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ReturnAwardGrant', @level2type=N'COLUMN',@level2name=N'TradeType'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'返利类型（1：充值返利【钻石】、2：游戏服务比例返利【金币】）' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ReturnAwardReceive', @level2type=N'COLUMN',@level2name=N'AwardType'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'领取前对应字段值 根据返利类型（1：充值返利【钻石】、2：游戏服务比例返利【金币】）' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ReturnAwardReceive', @level2type=N'COLUMN',@level2name=N'ReceiveBefore'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'返利类型（1：充值返利【钻石】、2：游戏服务比例返利【金币】）' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ReturnAwardRecord', @level2type=N'COLUMN',@level2name=N'AwardType'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'返利值 （根据返利类型（1：充值返利【钻石】、2：游戏服务比例返利【金币】））' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ReturnAwardRecord', @level2type=N'COLUMN',@level2name=N'Award'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'扩展字段：充值返利记录充值【充值订单号】；游戏服务比例返利记录【游戏名称-房间名称】' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ReturnAwardRecord', @level2type=N'COLUMN',@level2name=N'ExtraField'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'返利类型（1：充值返利【钻石】、2：游戏服务比例返利【金币】）' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ReturnAwardSteam', @level2type=N'COLUMN',@level2name=N'AwardType'
GO
