...
BEGIN
	...
	BEGIN
		...
		SET DrawCount=DrawCount+@UserDrawCount,BigWinnerCount=BigWinnerCount+@cbBigWinner, ScoreCount=ScoreCount+@lScore, RevenueCount=RevenueCount+@lRevenue ,CurScore=@CurUserScore-@lRevenue 
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				update   WHQJGroupDB.dbo.RecordTeamDayInfo 
				set DrawCount=DrawCount+@UserDrawCount,BigWinnerCount=BigWinnerCount+@cbBigWinner,ScoreCount=ScoreCount+@lScore,RevenueCount=RevenueCount+@lRevenue
		...
		BEGIN
			...
			BEGIN
				insert   WHQJGroupDB.dbo.RecordTeamDayInfo (DateID,GroupID,CaptainID,DrawCount,BigWinnerCount,ScoreCount,RevenueCount,ContributionValue,Flag)
				values(@dateID,@dwGroupID,@dwCaptainID,1,@cbBigWinner,@lScore,@lRevenue,0,0)
			END
