...
BEGIN
	-- 设置权限
	UPDATE  WHQJAccountsDB.dbo.AccountsInfo SET UserRight=UserRight|@dwAddRight WHERE UserID=@dwUserID
	UPDATE  WHQJAccountsDB.dbo.AccountsInfo SET UserRight=(~@dwRemoveRight)&UserRight WHERE UserID=@dwUserID	
END
