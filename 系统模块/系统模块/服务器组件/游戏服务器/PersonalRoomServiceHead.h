...
struct tagPersonalRoomManagerParameter
{
	...
	ITCPSocketService *				pAndroidITCPSocketService;		//网络服务
...
public:
	...
	//房卡支付
	virtual bool 	PersonalPayRoomCard(DWORD dwUserID, WORD wTableID, WORD wChairCount, DWORD dwPersonalRoomID,DWORD dwGroupID) = NULL;
