...
protected:
	...
	//聊天参数
protected:
	tagGameChatInfo					m_GameChatInfo;						//聊天参数
...
//	CSystemMessageArray				m_SystemMessageBuffer;				//消息缓冲	
	...
	CShareStorageServiceManager     m_ShareStorageServiceManager;		//库存管理
...
protected:
	...
	ITCPSocketService *				m_pAndroidITCPSocketService;		//AI分配网络服务器
