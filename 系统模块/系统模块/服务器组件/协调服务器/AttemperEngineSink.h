...
protected:
	...
	tagBindParameter				m_BindAI;							//绑定AI服务器	//组件变量
	WORD							m_wWebBindIndex;					//网站链接索引
...
protected:
	...
	//大联盟服务
	bool OnTCPNetworkMainClubService(WORD wSubCmdID, VOID * pData, WORD wDataSize, DWORD dwSocketID);
	//网站服务
