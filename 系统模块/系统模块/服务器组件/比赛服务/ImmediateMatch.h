...
public:
	...
	//AI调试
	virtual bool OnEventMatchAndroidDebug(CImmediateGroup *pMatch, WORD wPromotion, DWORD dwAndroidID1, DWORD dwAndroidID2, DWORD dwAndroidID3);
	//每轮结束
	virtual bool OnEventMatchRoundsOver(CImmediateGroup *pMatch,int wPromotion);
	//比赛结束
...
public:
	...
	//写入奖励
	virtual bool WriteUserAward(IServerUserItem *pIServerUserItem, tagMatchRankInfo * pMatchRankInfo);
	//用户退出
	virtual bool PromotionUserLogout(IServerUserItem *pIServerUserItem);
	//功能函数
public:
	//插入空的桌子
