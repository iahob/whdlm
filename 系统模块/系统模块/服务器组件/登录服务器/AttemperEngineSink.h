...
typedef CMap<int, int, tagRewardInfo, tagRewardInfo&>	CMapRewardInfo; //礼包内容
typedef CWHArray<tagLuaGameKind>	CLuaGameKind;						//Lua游戏列表
typedef CWHArray<tagH5GameKind>	CH5GameKind;						//Lua游戏列表
typedef CWHArray<tagU3DGameKind>	CU3DGameKind;						//Lua游戏列表
//////////////////////////////////////////////////////////////////////////////////
...
protected:
	...
	bool							m_bQueryFinish;						//请求列表是否结束
	bool							m_bNeekLogServer;					//日志服务器标志

	//配置变量
protected:
	CWHArray<tagSignInReward>		m_CheckInReward;					//签到奖励
	CMapRewardInfo					m_MapRewardInfo;					//礼包内容
	tagPlatformParameter			m_PlatformParameter;				//平台参数
	tagBaseEnsureParameter			m_BaseEnsureParameter;				//低保参数	
	CLuaGameKind					m_LuaGameKind;						//lua游戏类型
	CH5GameKind						m_H5GameKind;						//H5游戏类型
	CU3DGameKind					m_U3DGameKind;						//U3D游戏类型
...
protected:
	...
	//等级配置
protected:
	CMD_GP_ConfigGameServerLevel	m_DataConfigGameServerLevel;		//等级配置
...
protected:
	...
	ITCPSocketService *				m_LogServerTCPSocketService;		//日志服务引擎
public:
