...
VOID CInitParameter::InitParameter()
{
	...
	m_wServicePort = PORT_LOG_SERVER;
...
VOID CInitParameter::LoadInitParameter()
{
	...
	//读取配置
	m_wMaxConnect=IniData.ReadInt(TEXT("LogServer"),TEXT("ConnectMax"),m_wMaxConnect);
	m_wServicePort=IniData.ReadInt(TEXT("LogServer"),TEXT("ServicePort"),m_wServicePort);
