...
public:
	...
	//挂机标识
	virtual bool IsAndroidUserHanging() { return m_bAndroidHanging; }
	//设置挂机标识
	virtual VOID SetAndroidUserHanging(bool bAndroidHanging) { if (bAndroidHanging != m_bAndroidHanging) { m_bAndroidHanging = bAndroidHanging; } }
	//设置登录时间
	virtual VOID SetLogonTime(DWORD dwLogonTime) { if (dwLogonTime != m_dwLogonTime) { m_dwLogonTime = dwLogonTime; } }
	//获取登录时间
	virtual DWORD GetLogonTime() { return m_dwLogonTime; }
	//设置机器等级
	virtual VOID SetAndroidGrade(WORD wAndroidGrade) { if (wAndroidGrade != m_wAndroidGrade) { m_wAndroidGrade = wAndroidGrade; } }
	//获取机器等级
