...
bool CGameLevelParser::LoadGameLevelItem(LPCTSTR pszKindName, LPCTSTR pszDirectory, WORD wGameGenre)
{
	...
	{
		//文件目录
		_sntprintf_s(szGameLevelName,CountArray(szGameLevelName),TEXT("%s\\%s\\GoldGameLevel.ini"),szWorkDirectory,pszDirectory);
		...
		{
			//文件目录
			_sntprintf_s(szGameLevelName,CountArray(szGameLevelName),TEXT("%s\\GoldGameLevel.ini"),szWorkDirectory);
	...
	{
		//文件目录
		_sntprintf_s(szGameLevelName,CountArray(szGameLevelName),TEXT("%s\\%s\\GameLevel.ini"),szWorkDirectory,pszDirectory);
