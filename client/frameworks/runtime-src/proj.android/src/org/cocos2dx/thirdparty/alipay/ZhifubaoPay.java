...
import org.cocos2dx.thirdparty.alipay.util.OrderInfoUtil2_0;
import java.util.Map;

public class ZhifubaoPay {
    public static final int SDK_CHECK_FLAG = 2;

    public static final String RSA2_PRIVATE = ThirdDefine.ZFBRSA_PRIVATE;
    ...
    public void pay(float price, String productname) {
        ...
        // String orderInfo = getOrderInfo(productname, 
        ...
        Map<String, String> params = OrderInfoUtil2_0.buildOrderParamMap(ThirdDefine.ZFBAPP, rsa2, productname, "", df.format(price), getOrderNo());
        String orderParam = OrderInfoUtil2_0.buildOrderParam(params);

        String privateKey = rsa2 ? RSA2_PRIVATE : ThirdDefine.ZFBRSA_PRIVATE;
    ...
    public String sign(String content) {
        return SignUtils.sign(content, ThirdDefine.ZFBRSA_PRIVATE, false);
    }
