    ...
    for (SKPaymentTransaction *transaction in transactions) {
        ...
        switch (transaction.transactionState) {
            ...
            case SKPaymentTransactionStatePurchased:
            {
                ...
                NSString *URL= [NSString stringWithFormat:@"%s/MobilePay/IosPayNotify.aspx?UserID=%u&OrderID=%@&PayAmount=%d",_iosiap->m_strUrl.c_str(), _iosiap->m_dwUserID, transaction.transactionIdentifier, _iosiap->m_price];
