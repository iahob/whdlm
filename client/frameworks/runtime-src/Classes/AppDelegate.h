...
*/
class  AppDelegate : private cocos2d::Application, public cocos2d::Node, public cocos2d::LuaStackCryTo
{
...
public:
    ...
    */
    ...
    virtual unsigned char *script_encrypt(unsigned char *data, int data_len, int& result_len);
    virtual unsigned char *script_decrypt(unsigned char *data, int data_len, int& result_len);
};
