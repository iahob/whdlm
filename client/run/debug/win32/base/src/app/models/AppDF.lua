...
appdf.GAME_SHIELD                           = false

--appdf.GAME_DEBUG_IP                         = "game.nantonggame.cn"
appdf.GAME_DEBUG_IP                         = "47.104.218.16"
--appdf.GAME_DEBUG_IP                         = "61.160.236.12"
--appdf.GAME_DEBUG_IP                         = "123.129.198.67"
--appdf.GAME_DEBUG_IP                         = "qmgame.paouclub.com"
appdf.GAME_DEBUG_PORT                       = 8081
appdf.GAME_DEBUG_ADDRESS                    = "http://" .. appdf.GAME_DEBUG_IP .. ":" .. appdf.GAME_DEBUG_PORT
--下载信息
...
appdf.BASE_GAME = 
{
	--{kind = 522,version = "100000"},
	--{kind = 200,version = "100000"},
...
function appdf.centerNode(csbNode)
    if csbNode and csbNode:getChildByName("panel_mask") then
       csbNode:getChildByName("panel_mask"):setAnchorPoint(cc.p(0.5,0.5))
       csbNode:getChildByName("panel_mask"):setPosition(cc.p(appdf.WIDTH/2,appdf.HEIGHT/2))
       csbNode:getChildByName("panel_mask"):setContentSize(cc.size(display.width,display.height))
    end
    csbNode:setPositionX(display.cx - csbNode:getContentSize().width/2)
end
-- 字符分割
