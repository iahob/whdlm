...
function QueryDialog:ctor(msg, callback, txtsize, queryType,strC,strS)
	...
	-- 加载csb
	local csbNode = cc.CSLoader:createNode("QueryDialog.csb")
    ...
    local labttf = cc.Label:createWithTTF(msg, "fonts/round_body.ttf", txtsize, txtcontent:getContentSize(), cc.TEXT_ALIGNMENT_CENTER)
    labttf:setLineBreakWithoutSpace(true)
    labttf:setAnchorPoint(txtcontent:getAnchorPoint())
    labttf:setPosition(txtcontent:getPosition())
