...
function uiLocation:ctor(...)
    -- cc.FileUtils:getInstance():addSearchPath("game/qipai.thirteenzj/res/")
    self:init(...)
...
local pos = {{x=423,y=96},{x=1240,y=408},{x=886,y=601},{x=85,y=408}}
-- local pos = {{x=667,y=136},{x=1100,y=375},{x=667,y=600},{x=195,y=375}}
