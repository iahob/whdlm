...
cmd.RES_PATH 			= "game/qipai/thirteenzj/res/"
...
cmd.CMD_S_CompareCard = 
{
	...
	{k="lScoreTimes1",t="score",l={3,3,3,3}},
	{k="lScoreTimes2",t="score",l={3,3,3,3}},
	{k="lScoreTimes3",t="score",l={3,3,3,3}},
	{k="lScoreTimes4",t="score",l={3,3,3,3}},												--分段倍数
	{k="bSpecialType",t="byte",l={cmd.GAME_PLAYER}},											--特殊牌型
	{k="cbPlayCount",t="byte"},																	--游戏人数
	{k="bAllWin",t="int",l={cmd.GAME_PLAYER,cmd.GAME_PLAYER,cmd.GAME_PLAYER,cmd.GAME_PLAYER}},	--打枪信息
	{k="wAllKillUser",t="word"},
	{k="lScoreTimesPlus",t="score",l={4,4,4,4}},																--全垒打玩家		
}
...
cmd.CMD_S_GameEnd = 
{
	...
	{k="cbHandCard",t="byte",l={13,13,13,13}},							--玩家手牌												
}
...
{	
	...
	{k="cbMaCardData",t="byte"},												--码牌
	--游戏模式
    	{k = "cbPlayMode", t = "byte"},                          --游戏模式，0为积分房卡，1为金币房卡

    	{k = "cbTongHuaMode", t = "byte"},                          --同花比较，0先比点数，1先比花色
    	{k = "cbQuickMode", t = "bool"},                          --快速比牌，0不是，1是
}
...
{	
	...
	{k="wBanker",t="word"},													--庄家玩家
	{k="bGameStatus",t="bool",l={cmd.GAME_PLAYER}},							--游戏状态
	{k="lScoreTimes1",t="score",l={3,3,3,3}},								--分段倍数
	{k="lScoreTimes2",t="score",l={3,3,3,3}},
	{k="lScoreTimes3",t="score",l={3,3,3,3}},
	{k="lScoreTimes4",t="score",l={3,3,3,3}},
	{k="lScoreTimesPlus",t="score",l={4,4,4,4}},
	{k="bSpecialType",t="byte",l={cmd.GAME_PLAYER}},						--特殊牌型
	{k="cbPlayCount",t="byte"},												--游戏人数
	{k="bHaveBanker",t="byte"},												--霸王庄模式(0通比，1霸王庄)
	{k="nAllWinTimes",t="int"},												--打枪额外番数
	...
	{k="wServerID",t="word"},												--房间标识
	{k="cbMaCardData",t="byte"},											--码牌
	{k="cbTimeLeave",t="byte"},												--开牌剩余时间
	{k="bAllWin",t="int",l={cmd.GAME_PLAYER,cmd.GAME_PLAYER,cmd.GAME_PLAYER,cmd.GAME_PLAYER}},	--打枪信息
	{k="wAllKillUser",t="word"},																	--全垒打玩家
	{k = "cbPlayMode", t = "byte"},                          --游戏模式，0为积分房卡，1为金币房卡
	{k = "cbTongHuaMode", t = "byte"},                          --同花比较，0先比点数，1先比花色
	{k = "cbQuickMode", t = "bool"},                          --快速比牌，0不是，1是
}
...
{
	{k="cbMobilePutCount",t="byte"},--推荐牌型数目
	{k="cbMobilePutCard",t="byte",l={13,13,13}},
	{k="cbMobilePutCardType",t="byte",l={3,3,3}},

	{k="cbSpecialCardType",t="byte"},							--特殊牌型
	{k="cbSpecialData",t="byte",l={5, 5, 5}}
}
...
cmd.CMD_S_Record = 
{
	...
	{k="cbWinCount",t="byte",l={cmd.GAME_PLAYER}},--赢
	{k="cbLoseCount",t="byte",l={cmd.GAME_PLAYER}},--输
	{k="cbEqualCount",t="byte",l={cmd.GAME_PLAYER}},--平
}
