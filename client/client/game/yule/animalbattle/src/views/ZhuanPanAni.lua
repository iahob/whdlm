	...
	ZhuanPanAni.tabZhuanpanPos={
		-- cc.p(316.09,636.85),cc.p(488,702),cc.p(575,704),cc.p(662,702),cc.p(751,706),cc.p(838,700),cc.p(922,690),
		...
		-- cc.p(321,360),cc.p(245,396),cc.p(168,437),cc.p(201.11,394.57),cc.p(191.61,474.00),cc.p(191.61,555.43),cc.p(191.61,191.61)
	}
	...
	function ZhuanPanAni:moveAStep(node)
		...
		--print(node.m_index)
		ExternalFun.playSoundEffect("zhuanpan.mp3")
