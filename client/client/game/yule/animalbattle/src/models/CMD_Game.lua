...
cmd.JS_YAN_ZI    = 0 --燕子
cmd.JS_GE_ZI     = 1 --格子
cmd.JS_KONG_QUE  = 2 --孔雀
cmd.JS_LAO_YING  = 3 --老鹰
cmd.JS_SHI_ZI    = 4 --狮子
cmd.JS_XIONG_MAO = 5 --熊猫
cmd.JS_HOU_ZI    = 6 --猴子
cmd.JS_TU_ZI     = 7 --兔子
cmd.JS_YIN_SHA   = 8 --银沙
cmd.JS_TONG_PEI  = 9 --通陪
cmd.JS_TONG_SHA  = 10--通杀
cmd.JS_JIN_SHA   = 11--金沙
...
--趋势记录
cmd.CMD_S_SendRecord = 
{
	{t="byte",k="GameRecordArrary",l={65}}
}
...
cmd.CMD_S_StatusFree=
{
	...
	{t="string",k="szGameRoomName",s=32},					--房间名称 
	    -- 房间信息
    {k = "bShowTrend", t = "bool"},                        --房间名称
    {k = "lChipArray", t = "score",l = {5}},                        --房间名称
...
cmd.CMD_S_StatusPlay=  --StatusEnd也是用这个结构体
{
	...
	{t = "score", k = "lOtherUserScore"},                   --其他玩家成绩（不包括自己和体统）
