...
GameLogic.CHK_MASK_SMALL			=0x000000FF							--//小胡掩码
GameLogic.CHK_MASK_BIG				=0xFFFFFF00							--//大胡掩码

--//小胡牌型
GameLogic.CHR_PING_HU				=0x00000001							--//平胡
GameLogic.CHR_QIANG_GANG_HU     	=0x00000002							--//抢杠胡

--//大胡牌型
GameLogic.CHR_PENG_PENG				=0x00000200							--//碰碰胡
GameLogic.CHR_QI_DUI				=0x00000400							--//七对
GameLogic.CHR_TIAN_HU				=0x00000800							--//天胡
GameLogic.CHR_DI_HU					=0x00001000							--//地胡
GameLogic.CHR_QING_YI_SE			=0x00002000							--//清一色
GameLogic.CHR_ZI_YI_SE				=0x00004000							--//字一色
GameLogic.CHR_HUN_YI_SE				=0x00008000							--//混一色
GameLogic.CHR_XIAO_SAN_YUAN			=0x00010000							--//小三元
GameLogic.CHR_DA_SAN_YUAN			=0x00020000							--//大三元
GameLogic.CHR_XIAO_SI_XI			=0x00040000							--//小四喜	
GameLogic.CHR_DA_SI_XI				=0x00080000							--//大四喜
GameLogic.CHR_SI_AN_KE				=0x00100000							--//四暗刻
GameLogic.CHR_LUO_HAN				=0x00200000							--//十八罗汉	
GameLogic.CHR_SHI_SAN_YAO			=0x00400000							--//十三幺
--//未使用

GameLogic.CHR_GANG_SHANG_HUA  		=0x00000004                          --//杠上花
GameLogic.CHR_GANG_SHANG_PAO  		=0x00000008                          --//杠上炮
GameLogic.CHR_SHI_SAN_LAN			=0x04000000							 --//十三烂

GameLogic.LocalChiHuRight =
{
	{chr = GameLogic.CHR_PING_HU,str="平胡"},
	{chr = GameLogic.CHR_QIANG_GANG_HU,str="抢杠胡"},
