...
local cmd =  {}
cmd.RES_PATH                    =   "game/yule/oxeight/res/"
...
--游戏结束
cmd.GS_TK_WAITEND               = 103


--******************         牌状态             ************--
cmd.SEND_FOUR                  = 1 
cmd.SEND_COMPLETE              = 2    --所有牌发完
cmd.OPEN_CARD                  = 3    --开牌
...
cmd.SUB_S_ROOMCARD_RECORD       = 114       

cmd.SUB_S_SEND_FOUR_CARD             = 120         

cmd.SUB_S_GAME_STATUS             = 1000                     

-- 在线配牌相关
cmd.SUB_S_CONFIG_DEBUG          = 125         --请求调试
cmd.SUB_S_GET_POOL_CARD         = 126         --请求剩余牌池数据
cmd.SUB_S_REQUEST_CARDTYPE      = 127         --请求牌型
cmd.SUB_S_ERROR_NOTIFY          = 128         -- 错误提示
cmd.SUB_S_GAMEFREE_NOTIFY       = 129         -- //空闲通知
...
--配牌相关
cmd.SUB_C_CONFIG_DEBUG     = 17         -- 请求调试
cmd.SUB_C_GET_POOL_CARD    = 18         -- 获取剩余牌
cmd.SUB_C_CONFIG_CANCEL    = 19         -- 取消调试
cmd.SUB_C_REQUEST_CARDTYPE = 20         -- 请求牌型
cmd.SUB_C_REQUEST_CURCONFIG = 21         -- 请求当前调试状态
...
--*******************        时间标识         *****************--
--叫庄定时器
cmd.TIME_USER_CALL_BANKER		= 6
--开始定时器
cmd.TIME_USER_START_GAME		= 15
--加注定时器
cmd.TIME_USER_ADD_SCORE			= 7
--摊牌定时器
cmd.TIME_USER_OPEN_CARD			= 15


-------------------------------------------
cmd.AUTO_PLAY_FREE = 0
cmd.AUTO_PLAY_CALL = 1
cmd.AUTO_PLAY_BET = 2
cmd.AUTO_PLAY_OPENCARD = 3
cmd.AUTO_PLAY_START = 4
...
cmd.CMD_S_StatusFree = 
{
    ...
    { k = "gtConfig",t = "int"},                                       --是否有王

    { k = "wPlayerCountRule",t="word"},                                 --游戏规则 2-6人为0，其余为人数值
    { k = "cbAdmitRevCard",t = "byte"},                      --是否可以搓牌

        --游戏模式
    {k = "cbPlayMode", t = "byte"},                          --游戏模式，0为积分房卡，1为金币房卡

    { k = "wCardTypeTimes",t = "word",l = {cmd.MAX_CARD_TYPE}},            --牌型倍数

    { k = "nTimeStart",t = "int"},               --开始时间
    { k = "nTimeCallBanker",t = "int"},          --抢庄时间
    { k = "nTimeAddScore",t = "int"},            --下注时间
    { k = "nTimeOpenCard",t = "int"},            --开牌时间
...
cmd.CMD_S_StatusCall = 
{
    ...
    { k = "wPlayerCountRule",t = "word"},                                       --2-6人为0，其他的人数多少值为多少

    { k = "cbAdmitRevCard",t = "byte"},                      --是否可以搓牌
    { k = "cbMaxCallBankerTimes",t = "byte"},                      --最大抢庄倍数
    { k = "wNewTurnChairId",t="word"}, --第一局选择倍数玩家

            --游戏模式
    { k = "cbPlayMode", t = "byte"},                          --游戏模式，0为积分房卡，1为金币房卡
    { k = "cbTimeRemain",t = "byte"},                      --剩余时间
...
cmd.CMD_S_StatusScore = 
{
    ...
    { k = "cbCardData",t = "byte",l = {cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT}},                 --用户扑克
    ...
    { k = "lPlayerBetBtEx",t = "int",l = {cmd.GAME_PLAYER}},             --闲家额外推注
...
cmd.CMD_S_StatusPlay = 
{
    ...
    --扑克信息
    --桌面扑克
    { k = "cbHandCardData",t = "byte",l = {cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT}},
    ...
    { k = "cbPlayMode", t = "byte"},                          --游戏模式，0为积分房卡，1为金币房卡
    { k = "cbTimeRemain",t = "byte"},                      --剩余时间
    { k = "bDelayFreeDynamicJoin",t = "bool"},
    { k = "wCardTypeTimes",t = "word",l = {cmd.MAX_CARD_TYPE}},            --牌型倍数
...
cmd.CMD_S_CallBankerInfo = 
{
    { k = "cbCallBankerStatus",t = "byte",l = {cmd.GAME_PLAYER}},              --叫庄状态
    { k = "cbCallBankerTimes",t = "byte",l = {cmd.GAME_PLAYER}},               --叫庄倍数
    { k = "wCallBankerChairId",t = "word"},                                   --叫庄玩家
}
--游戏开始
cmd.CMD_S_GameStart = 
{
    ...
    { k = "lPlayerBetBtEx",t = "int",l = {cmd.GAME_PLAYER}},            --闲家额外的推注筹码
}
...
cmd.CMD_S_GameEnd = 
{
    ...
    { k = "cbCardData",t = "byte",l = {cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT}},
    { k = "cbCardType",t = "byte",l = {cmd.GAME_PLAYER}},                 --玩家牌型
    { k = "wCardTypeTimes",t = "word",l = {cmd.GAME_PLAYER}},                 --牌型倍数
    { k = "cbDelayOverGame",t = "byte"},                                  --
    { k = "cbLastCardData",t = "byte",l = {cmd.GAME_PLAYER}},                 --第五张牌
}
...
cmd.CMD_S_RoomCardRecord = 
{
    ...
    {k = "nCount", t = "word"},                                            --局数
    {k = "lDetailScore", t = "score", l = {30, 30, 30, 30,30,30,30,30}},        --积分信息
    {k = "cbPlayerStatus",t = "byte",l = {cmd.GAME_PLAYER}},               --玩家状态
...
cmd.stConfigDebug =
{
    {k = "wDebugUserChair", t = "word"},                            --调试玩家
    {k = "cbType", t = "byte"},                                     --调试类型   1-调试结果， 2-调试牌型
    {k = "cbGameWin", t = "byte"},                                  --调试结果   1-输， 2-赢
    {k = "cbGameCount", t = "byte"},                                --调试局数
    {k = "cbGameCards", t = "byte", l = {cmd.MAX_CARDCOUNT}},       --调试牌数据
    {k = "wConfigUserChair", t = "word"},                           --配置玩家
}

cmd.CMD_S_ConfigDebug = 
{
    {k = "stConfig", t = "table", d = cmd.stConfigDebug},   --调试配置
    {k = "cbCurDebugCount", t = "byte"},                    --当前调试局数
    {k = "cCards", t = "byte", l = {cmd.MAX_CARDCOUNT}},        --手牌
    {k = "bValidDebugType", t = "bool", l = {19}},        --手牌
    {k = "cbCurCardType", t = "byte"},                    --当前牌型
}

cmd.CMD_S_PoolCard =
{
    {k = "bCards", t = "bool", l = {54}},        --牌池
}

cmd.CMD_S_RequestCardType ={
    {k = "cbGameCards", t = "byte", l = {cmd.MAX_CARDCOUNT}},       --牌数据
}

cmd.CMD_S_ErrorNotify =
{
    {k = "msg", t = "string", s = 100}
}
---------------------客户端命令结构-------------------------
...
----------------------- 配牌相关-----------
cmd.CMD_C_ConfigDebug =
{
    {k = "stConfig", t = "table", d = cmd.stConfigDebug},
}


cmd.CMD_C_RequestCardType =
{
    {k = "wDebugUserChair", t = "word"},
    {k = "cbCardType", t = "byte"},
}


------------------头像状态显示---------------
cmd.US_Normal = 0   --正常无状态
cmd.US_Auto   = 1   --托管状态
cmd.US_CuoPai = 2   --搓牌
cmd.US_Bet    = 3   --下注中
cmd.US_Off    = 4   --断线
cmd.US_CuoWan = 5   --搓牌完成
return cmd