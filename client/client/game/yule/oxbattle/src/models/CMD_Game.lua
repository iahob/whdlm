...
cmd.SUB_S_CONTINUE_JETTON       = 109							    --重复下注
cmd.SUB_S_CONTINUE_JETTON_FAI   = 110                               --重复下注失败
...
cmd.tagServerGameRecord =
{
	...
	{k = "bMeJettonShunMen", t = "bool"},   --顺门胜利
	{k = "bMeJettonDuiMen", t = "bool"},	--对门胜利
	{k = "bMeJettonDaoMen", t = "bool"},	--到门胜利
	{k = "bMeJettonHuang", t = "bool"},		--黄门胜利
}
...
cmd.CMD_S_StatusPlay =
{
    ...
    -- 筹码配置
    {k = "lChipArray", t = "score", l = {7}},                --上局下注
    {k = "lLastUserJettonScore", t = "score", l = {cmd.AREA_COUNT+1}}
}
...
--继续下注
cmd.CMD_S_ContinueJetton =
{
	{k = "wChairID", t = "word"},						--用户位置
	{k = "lJettonScore", t = "score", l = {cmd.AREA_COUNT+1}},					--筹码区域
}

--继续下注失败
cmd.CMD_S_ContinueJettonFail =
{
	{k = "wChairID", t = "word"},						--用户位置
}
...
cmd.SUB_C_CONTINUE_JETTON		= 10				    --重复下注
