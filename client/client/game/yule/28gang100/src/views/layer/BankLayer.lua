...
BANK_BTN_NUM = {10000,100000,1000000, GlobalUserItem.tabAccountInfo.lUserScore, GlobalUserItem.tabAccountInfo.lUserInsure}
        ...
        if i == 6 then
            ...
            btn:addTouchEventListener(function(sender) 
                ...
                if sender:getTag() == 4 then
                    self.editboxNum:setText(BANK_BTN_NUM[sender:getTag()] - parent.myAllJettonScore)
                else
