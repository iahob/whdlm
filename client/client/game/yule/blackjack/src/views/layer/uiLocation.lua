...
function uiLocation:init(parent, playerList, playerNum)
    local csbNode = cc.CSLoader:createNode("location/LocationLayer.csb")
...
local pos = {{x=89,y=254},{x=68,y=441},{x=317,y=610},{x=660,y=645},{x=1007,y=612},{x=1293,y=446}}
...
function uiLocation:drawLine(src, dst, distance_km)
    ...
    local sprite = cc.Sprite:createWithSpriteFrame(cc.SpriteFrame:create("localtion/line_long.png", cc.rect(0,0,length,3)))
