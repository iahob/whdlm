...
cmd.VERSION_SERVER	=			"6.0.3"				--程序版本
cmd.VERSION_CLIENT	=			"6.0.3"				--程序版本
...
cmd.SUB_S_ROOMCARD_RECORD = 116									--房卡记录
...
cmd.CMD_S_StatusFree=
{
	...
	{t="bool",k="bZiMoAddTimes"},						--true允许自摸加倍
	{t="bool",k="bTianDiHu"},					---true为允许天地胡加倍
	{t="bool",k="bHaiDiLaoYue"}	,					--true允许海底捞月加倍
	{t="bool",k="bMenQing"},				  --true允许门清加倍

	 {k = "cbPlayMode", t = "byte"},                          --游戏模式，0为积分房卡，1为金币房卡
	 {t="word",k="szServerName"},        -- 金币房间场次
}
...
cmd.CMD_S_StatusChangeCard=
{
	...
	{t="byte",k="cbPriorChangeCardData",l={cmd.MAX_CHANGE_CARDCOUNT}},	--若bChangeCard为true，则cbChangeCardDataBefore为选择换三张的牌
	...
	{t="bool",k="bMenQing"},				  --true允许门清加倍
	 ...
	 {k = "cbPlayMode", t = "byte"},                          --游戏模式，0为积分房卡，1为金币房卡
	 {t="word",k="szServerName"},        -- 金币房间场次
	 {t="byte",k="cbTimeRemain"}         -- 同步服务器的时间
}
...
cmd.CMD_S_GameStart=
{
	...
	{t="bool",k="bHuanSanZhang"},       
	{t="score",k="lTurnScore",l={cmd.GAME_PLAYER}},
	{t="score",k="lCollectScore",l={cmd.GAME_PLAYER}},
	{t="byte",k="cbPriorChangeCardData",l={cmd.MAX_CHANGE_CARDCOUNT}},
...
cmd.Video_GameStart=
{
	{t="bool",k="bHuanSanZhang"},						--true为允许换三张
	{t="bool",k="bHuJiaoZhuanYi"},						--true允许呼叫转移
	{t="bool",k="bZiMoAddTimes"},						--true允许自摸加倍
	{t="bool",k="bTianDiHu"},							--true为允许天地胡加倍
	{t="bool",k="bHaiDiLaoYue"},						--true允许海底捞月加倍
	{t="bool",k="bMenQing"},							--true允许门清加倍
	...
	{t="word",k="wCurrentUser"},						--当前用户
	{t="byte",k="cbUserAction"},						--用户动作
	{t="byte",k="cbCardData",l={cmd.MAX_COUNT*cmd.GAME_PLAYER}},	--扑克列表 仅前cmd.MAX_COUNT个有效
	
	{t="byte",k="cbLeftCardCount"},					--剩余扑克
	{t="byte",k="cbSendCardData"},						--发送扑克 (不是庄家该值为INVALID_BYTE)
...
cmd.Video_GameEnd=
{
	...
	{t="byte",k="cbChiHuCardArray",l={cmd.GAME_PLAYER}},	--吃胡扑克数组
	...
	{t="table",k="tagHistoryChart",d=cmd.tagChart,l={cmd.MAX_CHART_COUNT,cmd.MAX_CHART_COUNT,cmd.MAX_CHART_COUNT,cmd.MAX_CHART_COUNT}}	--对局流水清单
}

--换三张结果
cmd.Video_ChangeCardResult=
{
	{t="byte",k="cbChangeType"},						--0顺时针 1逆时针 2对家
	{t="byte",k="cbChangeCardDataBefore",l={cmd.MAX_CHANGE_CARDCOUNT,cmd.MAX_CHANGE_CARDCOUNT,cmd.MAX_CHANGE_CARDCOUNT,cmd.MAX_CHANGE_CARDCOUNT}},	--换三张扑克(换之前)
	{t="byte",k="cbChangeCardDataAfter",l={cmd.MAX_CHANGE_CARDCOUNT,cmd.MAX_CHANGE_CARDCOUNT,cmd.MAX_CHANGE_CARDCOUNT,cmd.MAX_CHANGE_CARDCOUNT}},		--换三张扑克(换之后)
	{t="byte",k="cbSendCardData"},						--发牌扑克
}
...
cmd.SUB_C_REQUEST_RCRecord	=	16									--查询房卡记录
