...
--    elseif sub == cmd.SUB_S_TASK_INFO then              --任务信息 103
--        print("任务信息")
--        self:onSubTaskInfo(dataBuffer)                       
--    elseif sub == cmd.SUB_S_AWARD_INFO then             --中奖信息 104
--        print("中奖信息") 
...
--    dump(self.historyRecord,"GameLayer:CMD_S_HistoryRecord")
    self._gameView.trendLayer:updateList(self.historyRecord)
end
...
function GameLayer:onSubElementStop( dataBuffer )
    ...
    self.bIsStop = true  
    self.m_egglist              = {} 
--    cmd_table.cbItemInfo = {{0,0,7,7,7},{0,0,7,7,7},{0,0,7,7,7}}
...
--            self._gameView:onButtonClickedEvent(self._gameView.m_btnAuto:getTag(),self._gameView.m_btnAuto)
    ...
    if self._gameView.autoBegin then
        ...
        -- self._gameView.Button_line:setEnabled(false)
        -- self._gameView.Button_add:setEnabled(false)
        -- self._gameView.Button_check:setEnabled(false)
        self._gameView:setButtonEnable(false);
    else
...
--    else
        self._gameView.autoBegin = false
        -- self._gameView.Button_line:setEnabled(true)
        -- self._gameView.Button_add:setEnabled(true)
        -- self._gameView.Button_check:setEnabled(true)
        self._gameView:setButtonEnable(true);
        self._gameView:initButton()
...
function GameLayer:onGamePause()
    self._gameView.m_btnStart:loadTextures("game/bt_start_0.png", "game/bt_start_1.png","game/bt_start_3.png", ccui.TextureResType.plistType)
    self._gameView.m_btnStop:loadTextures("game/bt_stop_0.png", "game/bt_stop_1.png", "game/bt_stop_0.png", ccui.TextureResType.plistType)
    self._gameView.autoBegin = false
    -- self._gameView.Button_line:setEnabled(true)
    -- self._gameView.Button_add:setEnabled(true)
    -- self._gameView.Button_check:setEnabled(true)
