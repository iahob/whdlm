...
function SettingLayer:ctor( verstr )
    ...
    --加载csb资源
    self.SetLayer = ExternalFun.loadCSB("set/SettingLayer.csb", self)
    ...
    if GlobalUserItem.bVoiceAble == true then 
        self.m_btnMusic:loadTextureNormal("set/btn_check_on.png")
    else
        self.m_btnMusic:loadTextureNormal("set/btn_check_close.png")
    end
    if GlobalUserItem.bSoundAble == true then 
        self.m_btnEffect:loadTextureNormal("set/btn_check_on.png")
    else
        self.m_btnEffect:loadTextureNormal("set/btn_check_close.png")
    end
...
function SettingLayer:OnButtonClickedEvent( tag, sender )
    if SettingLayer.BT_MUSIC == tag then    --音乐
        ...
        if GlobalUserItem.bVoiceAble == true then 
            ...
            sender:loadTextureNormal("set/btn_check_on.png")
        else
            AudioEngine.stopMusic()
            sender:loadTextureNormal("set/btn_check_close.png")
        end
