...
--下注失败原因
cmd.BET_FAIL_INVALIDGAMESTATUS         = 1   --状态不对
cmd.BET_FAIL_INVALIDUSER               = 2   --庄家下注
cmd.BET_FAIL_INLIMIT                   = 3   --禁止下注
cmd.BET_FAIL_BEYONDLIMIT               = 4   --超过个人金币或者个人限制
cmd.BET_FAIL_ANDROIDRES                = 5   --游戏AI原因
cmd.BET_FAIL_BEYONDMAXSCORE            = 6   --超过个人最大可下注
cmd.BET_FAIL_BEYONDMAXSCORE            = 7   --结算退回
...
--重复下注
cmd.SUB_S_CONTINUE_JETTON		= 109
--重复下注失败
cmd.SUB_S_CONTINUE_JETTON_FAI	= 110
--发送下注(服务端消息)
...
--庄家在下注或者结算状态下主动下庄
cmd.SUB_S_BANKER_QUIT_RESULT     = 120
---------------------------------------------------------------------------------------
...
--继续下注
cmd.CMD_S_ContinuePlaceBet = {
    {k = "wChairID", t = "word"},
    {k = "lBetScore", t = "score", l = {cmd.AREA_MAX} },     --申请玩家
}

--继续下注失败
cmd.CMD_S_ContinuePlaceBetFail = {
    {k = "wChairID", t = "word"}
}
...
cmd.tagCustomAndroid = 
{
    ...
    --坐庄次数
    {k = "lRobotBankerCountMin", t = "int"},
    --坐庄次数
    {k = "lRobotBankerCountMax", t = "int"},
    --列表人数
    {k = "lRobotListMinCount", t = "int"},
    --列表人数
    {k = "lRobotListMaxCount", t = "int"},
    --最多申请个数
    {k = "lRobotApplyBanker", t = "int"},
    --空盘重申
    {k = "lRobotWaitBanker", t = "int"},
    
    --下注
    --下注筹码个数
    {k = "lRobotMinBetTime", t = "int"},
    --下注筹码个数
    {k = "lRobotMaxBetTime", t = "int"},
    --下注筹码金额
...
cmd.CMD_S_StatusFree = 
{
    ...
    -- 筹码配置
    {k = "ChipArray", t = "score", l = {cmd.MAX_CHIP_COUNT}},               
...
cmd.CMD_S_StatusPlay = 
{
    ...
    {k = "lLastPlayBet", t = "score", l = {cmd.AREA_MAX}},  --上局下注
    -- 筹码配置
    {k = "ChipArray", t = "score", l = {cmd.MAX_CHIP_COUNT}},
    {k = "CustomAndroid", t = "table", d = cmd.tagCustomAndroid}, --机器人配置
}
