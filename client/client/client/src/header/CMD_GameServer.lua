...
game_cmd.CMD_GR_LogonFailure =
{
	...
	{t = "word", k = "wKindID"},											--房间id
	{t = "word", k = "wServerID"},											--房间id
...
----------------------------------------------------------------------------------------------
-- 配置信息
game_cmd.MDM_GR_CONFIG = 2 													-- 配置信息

game_cmd.SUB_GR_CONFIG_COLUMN					= 100						--列表配置
game_cmd.SUB_GR_CONFIG_SERVER					= 101						--房间配置
game_cmd.SUB_GR_CONFIG_FINISH					= 102						--配置完成
--
----------------------------------------------------------------------------------------------
...
game_cmd.SUB_GR_USER_LOOKON 							= 2
game_cmd.SUB_GR_USER_SITDOWN						= 3 					-- 坐下请求
game_cmd.SUB_GR_USER_STANDUP						= 4						-- 起立请求
game_cmd.SUB_GR_USER_CHAIR_REQ 	   					= 10 					-- 请求更换位置
game_cmd.SUB_GR_USER_CHAIR_INFO_REQ 	 			= 11 					-- 请求椅子用户信息
game_cmd.SUB_GR_USER_WAIT_DISTRIBUTE				= 12					-- 等待分配
game_cmd.SUB_GR_USER_CHANGE_CHAIR    				= 14     				-- 换位置

--用户状态
game_cmd.SUB_GR_USER_ENTER							= 100					--用户进入
game_cmd.SUB_GR_USER_SCORE							= 101					--用户分数
game_cmd.SUB_GR_USER_STATUS							= 102					--用户状态
game_cmd.SUB_GR_REQUEST_FAILURE					 	= 103					--请求失败
game_cmd.SUB_GR_USER_GAME_DATA						= 104					--用户游戏数据
...
-- 用户分数
game_cmd.CMD_MobileUserScore = 
{
	{t = "dword", k = "dwUserID"},											-- 用户id
	{t = "table", k = "UserScore", d = cmdstruct.tagMobileUserScore} 		-- 积分信息
}
--
----------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------
--状态信息
game_cmd.MDM_GR_STATUS								= 4						--状态信息

game_cmd.SUB_GR_TABLE_INFO							= 100					--桌子信息
game_cmd.SUB_GR_TABLE_STATUS						= 101					--桌子状态
...
game_cmd.CMD_GR_S_UserInsureInfo = 
{
	...
	{k = "lBankOPButtonArray", t = "score", l = {5}},					--银行按钮配置
}
...
game_cmd.SUB_GP_LIST_PROPERTY						= 303




-- 道具列表
game_cmd.tagPropertyItem = 
{
	-- 道具信息
	-- 道具标识
	{t = "dword", k = "dwPropID"},
	...
	{t = "byte", k = "cbPlatformKind"},		--0:all,1:LUA,2:H5,3:U3D
}
...
game_cmd.CMD_GR_C_GamePropertyBuy = 
{
	...
	{t = "byte", k = "cbConsumeType"},--购买类型(0钻石1金币)
	-- 购买数目
...
game_cmd.SUB_GF_COMMOND_START		= 4										--分组确认
...
-- 场景消息
game_cmd.SUB_GF_GAME_STATUS			= 100									--游戏状态
game_cmd.SUB_GF_GAME_SCENE			= 101									--游戏场景
game_cmd.SUB_GF_LOOKON_STATUS		= 102									--旁观状态
...
game_cmd.SUB_GF_GAME_USER_COMMOND 		= 800								-- 显示开始按钮
...
game_cmd.CMD_GF_S_UserCommond = 
{
	{k = "dwUserID", t = "dword"},											--玩家标识
	{k = "wChairID", t = "word"},										--椅子标识
	{k = "dwWaitting", t = "dword"},									--等待时间
}
----------------------------------------------
...
game_cmd.DTP_GR_NICK_NAME						= 10						--用户昵称
game_cmd.DTP_GR_UNDER_WRITE						= 12 						--个性签名	
