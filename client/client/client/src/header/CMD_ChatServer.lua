...
chat_cmd.MDM_GC_MATCH					= 4

chat_cmd.SUB_GC_USER_STATUS_NOTIFY		= 1								--用户状态(上下线)
chat_cmd.SUB_GC_GAME_STATUS_NOTIFY 		= 2								--游戏动态()

chat_cmd.SUB_GC_MY_MATCH_HISTORY	    = 4
chat_cmd.SUB_GC_MY_MATCH_HISTORY_RESULT_T = 5
chat_cmd.SUB_GC_MY_MATCH_HISTORY_RESULT_F = 6
chat_cmd.SUB_GC_MY_MATCH_PLAYER_COUNT   = 7
...
chat_cmd.SUB_GC_MATCH_SIGNUP_COUNT		= 500							--比赛人数
...
chat_cmd.tagNearUserInfo =
{
	...
	{t = "string", k = "szPlaceName", s = 32}, 							--位置
...
--用户重入
chat_cmd.CMD_GC_UserLogonAfresh = 
{
	{k = "szNotifyMessage", t = "tchar", s = 128},				--描述信息
}
...
--比赛人数
chat_cmd.CMD_GS_S_MatchSignUpCount = 
{
	{t="score",k="lMatchNo"},				--比赛编号
	{t="dword",k="dwMatchCount"},			--比赛人数
	{t="word",k="wServerID"}
}


chat_cmd.CMD_GC_MyMatchHistory=
{
	{t="dword",k="dwUserID"},	
	{t="string",k="szPassword",s=yl.LEN_MD5}
}
...
chat_cmd.CMD_GC_MyMatchHistoryResult=
{
	{t="bool",k="bResultCode"}, --返回结果
	{t="string",k="szMatchName",s=32},--比赛名称
	{t="word",k="wKindID"},--游戏类型
	{t="word",k="wRandID"},--比赛名次
	{t="score",k="lRewardGold"},
	{t="score",k="lRewardDiamond"},
	{t = "table", k = "MatchStartTime", d = chat_cmd.SYSTEMTIME}, --比赛时间	
	{t="string",k="szDescribeString",s=128},--描述信息
}
