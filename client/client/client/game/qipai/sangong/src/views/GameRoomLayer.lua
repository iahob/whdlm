...
function GameRoomLayer:getTableParam()
    local table_bg = cc.Sprite:create("game/qipai/sangong/res/roomlist/roomtable.png")
    ...
    return table_bg, {cc.p(-3,160),cc.p(170,220),cc.p(342,160),cc.p(342,45),cc.p(170,-30),cc.p(-3,45)}
end
