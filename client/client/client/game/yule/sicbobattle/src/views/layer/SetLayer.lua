...
function SettingLayer:ctor( verstr )
    ...
    --音效
    self.m_btnEffect = self._csbNode:getChildByName("Button_music")
    ...
    --按钮纹理
    print("***************音乐****************",GlobalUserItem.bVoiceAble,GlobalUserItem.nMusic)
    ...
    print("***************音xiao****************",GlobalUserItem.bSoundAble,GlobalUserItem.nSound)
