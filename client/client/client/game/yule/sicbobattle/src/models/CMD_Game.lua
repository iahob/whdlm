...
cmd.tagCustomAndroid = 
{
	...
	{k = "lRobotBankerCountMin",t = "int"},						--坐庄次数
	{k = "lRobotBankerCountMax",t = "int"},						--坐庄次数
	{k = "lRobotListMinCount",t = "int"},							--列表人数
	{k = "lRobotListMaxCount",t = "int"}, 							--列表人数
	{k = "lRobotApplyBanker",t = "int"},							--最多申请个数
	{k = "lRobotWaitBanker",t = "int"},							--空盘重申

	--下注
	{k = "lRobotMinBetTime",t = "int"},							--下注筹码个数
	{k = "lRobotMaxBetTime",t = "int"},							--下注筹码个数
	{k = "lRobotMinJetton",t = "int"},							--下注筹码金额
	{k = "lRobotMaxJetton",t = "int"},							--下注筹码金额
	{k = "lRobotBetMinCount",t = "int"}, 							--下注机器人数
	{k = "lRobotBetMaxCount",t = "int"},							--下注机器人数
	{k = "lRobotAreaLimit",t = "int"},							--区域限制

	--存取款
	{k = "lRobotScoreMin",t = "int"},								--游戏币下限
	{k = "lRobotScoreMax",t = "int"},								--游戏币上限
	{k = "lRobotBankGetMin",t = "int"},							--取款最小值(非庄)
	{k = "lRobotBankGetMax",t = "int"},							--取款最大值(非庄)
	{k = "lRobotBankGetBankerMin",t = "int"}, 					--取款最小值(坐庄)
	{k = "lRobotBankGetBankerMax",t = "int"},						--取款最大值(坐庄)
	{k = "lRobotBankStoMul",t = "int"}							--存款百分比
}
--机器人配置
cmd.tagRobotConfig = 
{
