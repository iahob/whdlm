...
cmd.CMD_S_StatusFree = 
{
	...
	{k = "cbMaCount", t = "byte"},
	{k = "linitialScore", t = "score", l = {cmd.GAME_PLAYER}},		--初始积分
...
cmd.CMD_S_StatusPlay = 
{
	...
	{k = "linitialScore", t = "score", l = {cmd.GAME_PLAYER}},		--初始积分
        --游戏模式
	{k = "cbPlayMode", t = "byte"},                          --游戏模式，0为积分房卡，1为金币房卡
	{k = "cbRemainingTime", t = "byte"},                          --游戏模式，0为积分房卡，1为金币房卡
	-- 听牌提示
...
cmd.CMD_S_GameStart = 
{
	...
	{k = "lInitScore", t = "score", l = {cmd.GAME_PLAYER}},		--初始积分
	{k = "cbPlayStatus", t = "byte", l = {cmd.GAME_PLAYER}},		--游戏状态
}
-- --机器人扑克
...
cmd.SUB_C_REQUEST_RECORD            = 7									--请求记录
--出牌命令
cmd.CMD_C_OutCard = 
{
	{k = "cbCardData", t = "byte"}								--扑克数据
