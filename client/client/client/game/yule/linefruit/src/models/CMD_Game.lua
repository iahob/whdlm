...
cmd.RES 						= "game/yule/linefruit/res/"
cmd.GAME 					    = "linefruit/"
...
cmd.CT_BANANA					= 2									    --香蕉
cmd.CT_LEMON					= 3									    --柠檬
cmd.CT_STRAWBERRY				= 4									    --草莓
cmd.CT_WATERMELON				= 5									    --西瓜
cmd.CT_STAR				        = 6									    --星星
cmd.CT_BAR					    = 7									    --BAR
cmd.CT_COMPOTE					= 8									    --果盘（癞子）
cmd.CT_ICECREAM					= 9									    --圣代
cmd.CT_SEVEN				    = 10								    --SEVEN
cmd.CT_BRAZIL					= 11								    --巴西
cmd.CT_CHINA					= 12								    --中国
...
cmd.SUB_S_SUPERRABBIT_START		= 105									--超级兔子开始
cmd.SUB_S_SUPERRABBIT_END		= 106									--超级兔子结束
...
{	
    ...
    {t = "byte", k = "cbItemType", l = {cmd.MAX_LINE_COUNT}},			--线类型
    {t = "int", k = "nSuperRabbit"},			                        --赠送次数
    {t = "score", k = "lSuperRabbitScore"},			                    --游戏中贪吃兔子,总得分为押线获得金币数X 贪吃兔游戏中奖倍率
...
cmd.SUB_C_SUPERRABBIT_START		= 103									--超级兔子开始（没有消息包）
cmd.SUB_C_SUPERRABBIT_END		= 104									--超级兔子结束
...
--超级兔子结束
cmd.CMD_C_SuperRabbitEnd = 
{
    {t = "int", k = "nCurSuperRabbit"},			                        --当前贪吃兔子的倍率
}

--超级兔子开始
cmd.CMD_S_SupperRabbitStart = 
{
    {t = "int", k = "nSuperRabbit"},			                        --贪吃兔子的倍率(0代表不是贪吃兔子)
    {t = "score", k = "lSuperRabbitScore"},					            --游戏中贪吃兔子,总得分为押线获得金币数X 贪吃兔游戏中奖倍率
}

--超级兔子结束
cmd.CMD_S_SupperRabbitEnd = 
{
    {t = "int", k = "nCurSuperRabbit"},			                        --贪吃兔子的倍率(0代表不是贪吃兔子)
    {t = "score", k = "lCurSuperRabbitScore"},					        --游戏中贪吃兔子,总得分为押线获得金币数X 贪吃兔游戏中奖倍率
}
...
cmd.CMD_S_StatusPlay = 
{
    ...
    {t = "score", k = "lLineScore", l = {cmd.MAX_LINE_COUNT}},			--线得分
    {t = "byte", k = "cbItemType", l = {cmd.MAX_LINE_COUNT}},		    --线类型
    {t = "int", k = "nSuperRabbit"},			                        --贪吃兔子的倍率(0代表不是贪吃兔子)
    {t = "score", k = "lSuperRabbitScore"},			                    --游戏中贪吃兔子,总得分为押线获得金币数X 贪吃兔游戏中奖倍率
    {t = "int", k = "nGiveAwayCount"},			                        --赠送次数
