...
function UserListLayer:ctor( )
    ...
    cc.funAddChildListenerWithTag(csbNode, "layout_bg", UserListLayer.BT_CLOSE, btnEvent)
    cc.funAddChildListenerWithTag(csbNode, "sp_userlist_bg/Button_4", UserListLayer.BT_CLOSE, btnEvent)
