...
function SettingLayer:ctor()
    ...
    -- 加载csb资源
    local rootLayer, csbNode = ExternalFun.loadRootCSB("setting/Layer.csb", self)
    ...
    -- 音乐滑动
    local slider_music = csbNode:getChildByName("Slider_1")
    ...
    -- 音效滑动
    local slider_effect = csbNode:getChildByName("Slider_1_0")
...
function SettingLayer:onTouchEnded(touch, event)
   local pos = touch:getLocation() 
    local m_spBg = self.m_rootLayer:getChildByName("bg1_2")
