...
function SettingLayer:ctor( parent )
    ...
    if GlobalUserItem.bSoundAble == true then
        --设置纹理
        self.m_btnEffect:loadTextureNormal(cmd.RES_PATH.."setting/kwx_btn_off.png")
        self.m_btnEffect:loadTexturePressed(cmd.RES_PATH.."setting/kwx_btn_off_2.png")
    else
         --设置纹理
        self.m_btnEffect:loadTextureNormal(cmd.RES_PATH.."setting/kwx_btn_on.png")
        self.m_btnEffect:loadTexturePressed(cmd.RES_PATH.."setting/kwx_btn_on_2.png")
    end
    ...
    if GlobalUserItem.bVoiceAble == true then
        --设置纹理
        self.m_btnMusic:loadTextureNormal(cmd.RES_PATH.."setting/kwx_btn_off.png")
        self.m_btnMusic:loadTexturePressed(cmd.RES_PATH.."setting/kwx_btn_off_2.png")
    else
         --设置纹理
        self.m_btnMusic:loadTextureNormal(cmd.RES_PATH.."setting/kwx_btn_on.png")
        self.m_btnMusic:loadTexturePressed(cmd.RES_PATH.."setting/kwx_btn_on_2.png")
    end
