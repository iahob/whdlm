...
function ClubRoomCreateLayer:ctor( scene,param,level )
    ...
    if self.param.tabConfigInfo then
        ...
        for i=1,10 do
            self.lastData[i] = cc.UserDefault:getInstance():getIntegerForKey(GlobalUserItem.tabAccountInfo.dwUserID.."sparrowxykwxData"..i, -1)
        end
    end
    ...
    --游戏人数
    for i = 2, 3 do
        local checkbx = self.m_nodeRule:getChildByName("node_config_2"):getChildByName("palyer" .. i)
        if nil ~= checkbx then
    ...
    self.m_tabRuleCheckBox[self.selectPlayer]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")

    --定漂配置
    for i = 1, 3 do
        local checkbx = self.m_nodeRule:getChildByName("node_config_3"):getChildByName("piao" .. i)
        if nil ~= checkbx then
            checkbx:setVisible(true)
            checkbx:setTouchEnabled(true)
            checkbx:setTag(CBT_PIAO + i)
            checkbx:addTouchEventListener(cbtlistener)
            checkbx:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
            self.m_tabRuleCheckBox[CBT_PIAO + i] = checkbx
        end
    end    
    self.selectPiao = CBT_PIAO + 1
    self.m_tabRuleCheckBox[self.selectPiao]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")
 

     --游戏玩法
    for i = 1, 2 do
        local checkbx = self.m_nodeRule:getChildByName("node_config_4"):getChildByName("wanfa" .. i)
        if nil ~= checkbx then
            checkbx:setVisible(true)
            checkbx:setTouchEnabled(true)
            checkbx:setTag(CBT_WF + i)
            checkbx:addTouchEventListener(cbtlistener)
            checkbx:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
            self.m_tabRuleCheckBox[CBT_WF + i] = checkbx
        end
    end    
    self.selectwf = CBT_WF + 1
    self.m_tabRuleCheckBox[self.selectwf]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")


    --马牌模式
    for i = 1, 3 do
        local checkbx = self.m_nodeRule:getChildByName("node_config_5"):getChildByName("maMode" .. i)
        if nil ~= checkbx then
            checkbx:setVisible(true)
            checkbx:setTouchEnabled(true)
            checkbx:setTag(CBT_MAMODE + i)
            checkbx:addTouchEventListener(cbtlistener)
            checkbx:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
            self.m_tabRuleCheckBox[CBT_MAMODE + i] = checkbx
        end
    end    
    self.selectMaMode = CBT_MAMODE + 1
    self.m_tabRuleCheckBox[self.selectMaMode]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")



    --马牌
    for i = 1, 3 do
        local checkbx = self.m_nodeRule:getChildByName("node_config_6"):getChildByName("ma" .. i)
        if nil ~= checkbx then
            checkbx:setVisible(true)
            checkbx:setTouchEnabled(true)
    ...
    self.selectMa = CBT_MA + 1
    self.m_tabRuleCheckBox[self.selectMa]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")
...
function ClubRoomCreateLayer:updateConfigSetting()
    ...
    self.m_tabRuleCheckBox[self.selectPlayer]:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
    self.selectPlayer = self.param.tabConfigInfo.cbGameRule[1][2] + CBT_PLAYER
    self.m_tabRuleCheckBox[self.selectPlayer]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")


    self.m_tabRuleCheckBox[self.selectPiao]:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
    self.selectPiao = self.param.tabConfigInfo.cbGameRule[1][4] + CBT_PIAO + 1
    self.m_tabRuleCheckBox[self.selectPiao]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")

    self.m_tabRuleCheckBox[self.selectwf]:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
    self.selectwf = self.param.tabConfigInfo.cbGameRule[1][7] + CBT_WF + 1
    self.m_tabRuleCheckBox[self.selectwf]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")

    self.m_tabRuleCheckBox[self.selectMaMode]:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
    self.selectMaMode = (self.param.tabConfigInfo.cbGameRule[1][5] == 0 and 3 or self.param.tabConfigInfo.cbGameRule[1][5]) +  CBT_MAMODE 
    self.m_tabRuleCheckBox[self.selectMaMode]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")


    self.m_tabRuleCheckBox[self.selectMa]:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
    self.selectMa = self.param.tabConfigInfo.cbGameRule[1][6] + CBT_MA
    self.m_tabRuleCheckBox[self.selectMa]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")
...
function ClubRoomCreateLayer:updateLastData()
    ...
    self.m_tabRuleCheckBox[self.selectPlayer]:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
    self.selectPlayer = self.lastData[6] + CBT_PLAYER
    self.m_tabRuleCheckBox[self.selectPlayer]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")


    self.m_tabRuleCheckBox[self.selectPiao]:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
    self.selectPiao = self.lastData[7] + CBT_PIAO + 1
    self.m_tabRuleCheckBox[self.selectPiao]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")

    self.m_tabRuleCheckBox[self.selectwf]:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
    self.selectwf = self.lastData[10] + CBT_WF + 1
    self.m_tabRuleCheckBox[self.selectwf]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")

    self.m_tabRuleCheckBox[self.selectMaMode]:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
    self.selectMaMode = (self.lastData[8] == 0 and 3 or self.lastData[8]) +  CBT_MAMODE 
    self.m_tabRuleCheckBox[self.selectMaMode]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")


    self.m_tabRuleCheckBox[self.selectMa]:getChildByName("Sprite_11"):setTexture("room/dt_dian1.png")
    self.selectMa = self.lastData[9] + CBT_MA
    self.m_tabRuleCheckBox[self.selectMa]:getChildByName("Sprite_11"):setTexture("room/dt_dian2.png")
...
function ClubRoomCreateLayer:sendGroupConfig()
            ...
            buffer:pushword(self.gx_flag and 3 or self.selectPlayer -CBT_PLAYER)    --游戏人数
            ...
            buffer:pushbyte(self.gx_flag and 3 or self.selectPlayer -CBT_PLAYER)
            ...
            buffer:pushbyte(self.selectPiao -CBT_PIAO -1) --0:不漂,1:漂一次,2每次要
            buffer:pushbyte(selTypeList[self.selectMaMode - CBT_MAMODE]) --0:不买马,1:自摸买马,2:亮倒自摸买马
            buffer:pushbyte(self.selectMa - CBT_MA) --0:无,1:买1马,2:买6马,3:买一送一
            buffer:pushbyte(self.selectwf - CBT_WF - 1) --0:全频道,1:半频道
            for i= 1,93 do
                buffer:pushbyte(0)
            end
            ...
            table.insert(lastData,self.selectPiao -CBT_PIAO -1)

            table.insert(lastData,selTypeList[self.selectMaMode - CBT_MAMODE])

            table.insert(lastData,self.selectMa - CBT_MA)

            table.insert(lastData,self.selectwf - CBT_WF - 1)


            if self.m_isCreate then --保存当前配置
                for i=1, 10 do
                    cc.UserDefault:getInstance():setIntegerForKey(GlobalUserItem.tabAccountInfo.dwUserID.."sparrowxykwxData"..i, lastData[i])
                end
            end
...
function ClubRoomCreateLayer:getInviteShareMsg( roomDetailInfo )
    ...
    local shareTxt = "局数:" .. turnCount .. "局。卡五星游戏精彩刺激, 一起来玩吧!"
    local url = yl.PRIVATE_SHARE_URL .. "?g=" .. GlobalUserItem.tabAccountInfo.dwGameID .. "&r=" .. dwRoomID .. "&k=707&a=1" .. "&p=" .. passwd
...
function ClubRoomCreateLayer:getCopyShareMsg(roomDetailInfo)
    ...
    return {content = string.format("卡五星, 房号[%06d],您的好友喊你打牌了!", dwRoomID)}
end
...
function ClubRoomCreateLayer:updateXunZhang()
    ...
    self.m_nodeRule:setPositionY(self.gx_flag and 496 or self.m_nodeScore:getPositionY())

    self.m_nodeRule:getChildByName("node_config_2"):setVisible(not self.gx_flag and true or false)

    for i=3,6 do
        self.m_nodeRule:getChildByName("node_config_"..i):setPositionY((not self.gx_flag and -143 or -83) - (i-3)*60)
    end
...
function ClubRoomCreateLayer:onRuleSelectedEvent(tag, sender)
    ...
    if tag > CBT_PLAYER  and tag < CBT_PIAO then 
        for k,v in pairs(self.m_tabRuleCheckBox) do
                if k > CBT_PLAYER and k < CBT_PIAO then 
                    v:getChildByName("Sprite_11"):setTexture(k == tag and "room/dt_dian2.png" or "room/dt_dian1.png")
                end
        end
        self.selectPlayer = tag
    end

    if tag > CBT_PIAO  and tag < CBT_WF then 
        for k,v in pairs(self.m_tabRuleCheckBox) do
                if k > CBT_PIAO and k < CBT_WF then
                    v:getChildByName("Sprite_11"):setTexture(k == tag and "room/dt_dian2.png" or "room/dt_dian1.png")
                end
        end
        self.selectPiao = tag
    ...
    if tag > CBT_WF  and tag < CBT_MAMODE then 
        for k,v in pairs(self.m_tabRuleCheckBox) do
                if k > CBT_WF and k < CBT_MAMODE then
                    v:getChildByName("Sprite_11"):setTexture(k == tag and "room/dt_dian2.png" or "room/dt_dian1.png")
                end
        end
        self.selectwf = tag
    ...
    if tag > CBT_MAMODE  and tag < CBT_MA then 
        for k,v in pairs(self.m_tabRuleCheckBox) do
                if k > CBT_MAMODE and k < CBT_MA then
                    v:getChildByName("Sprite_11"):setTexture(k == tag and "room/dt_dian2.png" or "room/dt_dian1.png")
                end
        end
        self.selectMaMode = tag

        for i=1,3 do
            local maBtn = self.m_nodeRule:getChildByName("node_config_6"):getChildByName("ma" .. i)
            maBtn:getChildByName("Text_22"):setColor(tag == CBT_MAMODE + 3 and cc.c3b(127,127,127) or cc.c3b(255,255,255))
            maBtn:setEnabled(tag ~= CBT_MAMODE + 3 and true or false)
        end
