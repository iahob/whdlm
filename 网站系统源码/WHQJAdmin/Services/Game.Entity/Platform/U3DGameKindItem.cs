...
{
    /// <summary>
    /// 实体类 U3DGameKindItem  (属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class U3DGameKindItem
    {
        #region 常量 
        ...
        /// 表名
        /// </summary>
        public const string Tablename = "U3DGameKindItem";
