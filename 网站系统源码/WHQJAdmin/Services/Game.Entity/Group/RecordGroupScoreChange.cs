...
{
    /// <summary>
    /// 实体类 RecordGroupScoreChange  (属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class RecordGroupScoreChange
    {
        #region 常量 
        ...
        /// 表名
        /// </summary>
        public const string Tablename = "RecordGroupScoreChange";
        ...
        /// <summary>
        /// 初始化RecordGroupScoreChange
        /// </summary>
        public RecordGroupScoreChange() 
        {
            p_recordid = 0;
            p_groupid = 0;
            p_beforescore = 0;
