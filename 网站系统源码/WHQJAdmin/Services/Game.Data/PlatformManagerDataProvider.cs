...
namespace Game.Data
{
    ...
    public class PlatformManagerDataProvider : BaseDataProvider, IPlatformManagerDataProvider
    {
        ...
        /// <returns></returns>
        public int InsertSystemSecurity(SystemSecurity model)
        {
            string sqlQuery = @"INSERT INTO dbo.SystemSecurity(OperatingTime ,OperatingName ,OperatingIP ,OperatingAccounts) VALUES(GETDATE() ,@OperatingName,@OperatingIP,@OperatingAccounts)";

            var prams = new List<DbParameter>
            {
                Database.MakeInParam("OperatingName", model.OperatingName),
                Database.MakeInParam("OperatingIP", model.OperatingIP),
                Database.MakeInParam("OperatingAccounts", model.OperatingAccounts)
            };
