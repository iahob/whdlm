...
namespace Game.IData
{
    ...
    public interface IAgentDataProvider
    {
        ...
        /// </summary>
        /// <returns></returns>
        DataSet GetAgentReturnConfigList();
        /// <summary>
        /// 获取代理返利配置
        /// </summary>
        ...
        /// <param name="pageSize">页显示数</param>
        /// <returns></returns>
        PagerSet GetPageAgentList(string where, string order, int pageIndex, int pageSize);
        /// <summary>
        /// 分页获取数据列表
        /// </summary>
        /// <param name="where">查询条件</param>
        ...
        /// <param name="pageSize">页显示数</param>
        /// <returns></returns>
        PagerSet GetPageAgentReturnList(string where, string order, int pageIndex, int pageSize);
        /// <summary>
        /// 分页获取数据列表
        /// </summary>
        /// <param name="where">查询条件</param>
        ...
        /// <param name="pageSize">页显示数</param>
        /// <returns></returns>
        PagerSet GetPageAgentGrantList(string where, string order, int pageIndex, int pageSize);
        /// <summary>
        /// 获取代理信息
        /// </summary>
        ...
        /// <returns></returns>
        DataSet GetAgentBelowRegisterList(int agentId);
