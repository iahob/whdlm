...
namespace Game.Facade
{
    ...
    public class AgentFacade
    {
        ...
        {
            return agentData.GetList(tableName, where, order, pageIndex, pageSize, fields);
        }
        #endregion 公用分页
        ...
        {
            return agentData.GetSystemStatusList();
        }
        /// <summary>
        /// 获取配置信息
        /// </summary>
        ...
        {
            return agentData.GetAgentReturnConfigList();
        }
        /// <summary>
        /// 获取代理返利配置
        /// </summary>
        ...
        {
            return agentData.GetPageAgentList(where, order, pageIndex, pageSize);
        }
        /// <summary>
        /// 分页获取数据列表
        /// </summary>
        ...
        {
            return agentData.GetPageAgentReturnList(where, order, pageIndex, pageSize);
        }
        /// <summary>
        /// 分页获取数据列表
        /// </summary>
        ...
        {
            return agentData.GetPageAgentGrantList(where, order, pageIndex, pageSize);
        }
        /// <summary>
        /// 获取代理信息
        /// </summary>
