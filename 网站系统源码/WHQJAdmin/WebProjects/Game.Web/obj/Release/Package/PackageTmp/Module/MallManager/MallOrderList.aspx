        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
                <tr align="center" class="bold"> 
                    ...
                    <td class="listTitle2">用户昵称</td>
                    <td class="listTitle2">商品名称</td>
                    <td class="listTitle2">商品价格（奖券）</td>
                    <td class="listTitle2">购买数量</td>
                    <td class="listTitle2">花费金额（奖券）</td>
                    <td class="listTitle2">兑换游戏币值（单个）</td>
                    <td class="listTitle2">兑换钻石值（单个）</td>
