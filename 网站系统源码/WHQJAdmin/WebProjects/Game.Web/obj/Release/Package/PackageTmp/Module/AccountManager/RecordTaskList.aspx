<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordTaskList.aspx.cs" Inherits="Game.Web.Module.AccountManager.RecordTaskList" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="28">
                <ul>
                    <li class="tab2" onclick="Redirect('TaskList.aspx')">任务管理</li>
                    <li class="tab1">任务记录</li>
                </ul>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="txtEndDate" runat="server" CssClass="text wd2" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'txtStartDate\')}'})"></asp:TextBox><img
                    ...
                    style="cursor: pointer; vertical-align: middle" />
                <asp:Button ID="Button2" runat="server" Text="查询" CssClass="btn wd1" OnClick="btnQuery_Click" />
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <%# GetTaskInfo(Convert.ToInt32(Eval( "TaskID" )))%>
                        <td>
