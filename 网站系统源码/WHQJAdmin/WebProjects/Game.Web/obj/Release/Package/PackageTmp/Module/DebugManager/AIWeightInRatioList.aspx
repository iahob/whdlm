<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AIWeightInRatioList.aspx.cs" Inherits="Game.Web.Module.DebugManager.AIWeightInRatioList" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">你当前位置：调试系统 - AI设置 - 进入房间权重</td>
        </tr>
    </table>
    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
            <tr align="center" class="bold">
                ...
                <td class="listTitle2">AI进入游戏房间的概率(%)</td>  
            </tr>
            <asp:Repeater ID="rptIssue" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">    
                        <td>                             
                            <a class="l" href="AIWeightInRatioInfo.aspx?param=<%#Eval("ID") %>">编辑</a>              
                        </td>                
