<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyGold.aspx.cs" Inherits="Game.Web.Module.DataStatistics.DailyGold" %>
<!DOCTYPE html>
...
<body>
    ...
    <h2 style="text-align: center;margin-bottom: 5px;">平台每日金币</h2>
    <div id="content">
    </div>
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            $.ajax({
                type: "GET",
                url: "/Tools/Operating.ashx?action=getplatformgold",
