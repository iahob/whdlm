...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
            <td class="listTdLeft">登录密码：
            </td>
            <td style="width: 150px;">
                <asp:TextBox ID="txtLogonPass" CssClass="text" runat="server" TextMode="Password"></asp:TextBox>
                （为空则不修改）
            </td>
            <td class="listTdLeft">
                银行密码：
        ...
        <tr>
            ...
            <td style="width: 150px;">
                <asp:TextBox ID="txtRegisterMobile" CssClass="text" MaxLength="18" runat="server"></asp:TextBox>
            </td>
