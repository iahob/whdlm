...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
        ...
        <tr>
          ...
          <td>
              <asp:DropDownList ID="ddlLevel" runat="server" Width="156px">
        ...
        <tr>
          ...
          <td>
            <asp:DropDownList runat="server" ID="ddlAwardType" Width="156px">
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td class="titleOpBg Lpd10">
                <input id="btnReturn2" type="button" value="返回" class="btn wd1" onclick="Redirect('AgentReturnConfigList.aspx')" />
