<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyOpenRoom.aspx.cs" Inherits="Game.Web.Module.DataStatistics.DailyOpenRoom" %>
<!DOCTYPE html>
...
<body>
    ...
    <h2 style="text-align: center;margin-bottom: 5px;">平台每日开房</h2>
    <div id="content">
    </div>
    ...
    <script type="text/javascript">
        ...
        chart.line().position('time*count').color('type', ['#ff7f0e','#2ca02c']).shape('smooth').size(2);
        chart.render();
        ...
        function loadData() {
            $.ajax({
                type: "GET",
                url: "/Tools/Operating.ashx?action=getuseropenroom",
