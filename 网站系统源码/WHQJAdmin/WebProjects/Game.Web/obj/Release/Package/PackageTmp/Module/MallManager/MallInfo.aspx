           ...
           <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:ListItem Text="游戏币" Value="1"></asp:ListItem>
                        <asp:ListItem Text="日常" Value="2"></asp:ListItem>
                        <asp:ListItem Text="数码" Value="3"></asp:ListItem>
                        <asp:ListItem Text="卡券" Value="4"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtPrice" runat="server" CssClass="text wd7" MaxLength="8"></asp:TextBox>
                        &nbsp;<span class="hong">*</span> 奖券
                ...
                <tr>
                    <td class="listTdLeft">游戏币值：</td>
                    <td><asp:TextBox ID="txtGold" runat="server" CssClass="text wd7" Text="0"></asp:TextBox>
                        &nbsp;<span class="hong">*</span> （单个）
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtGold" ErrorMessage="游戏币值不能为空"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtGold" ValidationExpression="^[0-9]\d*$" ErrorMessage="商品价格必须为正整数"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td class="listTdLeft">钻石值：</td>
                    <td><asp:TextBox ID="txtDiamond" runat="server" CssClass="text wd7" Text="0"></asp:TextBox>
                        &nbsp;<span class="hong">*</span> （单个）
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtDiamond" ErrorMessage="钻石值不能为空"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="txtDiamond" ValidationExpression="^[0-9]\d*$" ErrorMessage="商品价格必须为正整数"></asp:RegularExpressionValidator>
                    </td>
                </tr>
               ...
               <%-- <tr>
                ...
                <tr>
                    <td class="listTdLeft">商品大图：</td>
                    <td style="line-height:35px;">
                        <GameImg:ImageUploader ID="upBigImage" runat="server" DeleteButtonClass="l2" DeleteButtonText="删除" Folder="/Upload/Match" ViewButtonClass="l2" ViewButtonText="查看" TextBoxClass="text"/>  &nbsp;<span class="hong">*</span><span>[尺寸：310*310]</span>
                    </td>
                </tr>
              <%--  <tr>
