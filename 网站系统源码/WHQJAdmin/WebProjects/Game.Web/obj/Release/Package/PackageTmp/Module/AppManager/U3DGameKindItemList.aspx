<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="U3DGameKindItemList.aspx.cs" Inherits="Game.Web.Module.AppManager.U3DGameKindItemList" %>
        ...
        <tr>
            <td height="28">
                <ul>
                    ...
                    <li class="tab2" onclick="Redirect('MobileKindList.aspx')">LUA游戏列表</li>
                    <li class="tab1">U3D游戏列表</li>
                     <li class="tab2" onclick="Redirect('H5GameKindItemList.aspx')">H5游戏列表</li>
                </ul>
            </td>
        </tr>
    </table>
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('U3DGameKindItemInfo.aspx?cmd=add')" />
            ...
            <asp:Repeater ID="rptMobileKindItem" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">
                        ...
                        <td>                             
                            <a class="l" href="U3DGameKindItemInfo.aspx?cmd=edit&param=<%#Eval("KindID") %>">编辑</a>              
                        </td>          
                        <td><%# Eval("KindID")%></td>    
                        <td><%# Eval("KindName")%></td>       
