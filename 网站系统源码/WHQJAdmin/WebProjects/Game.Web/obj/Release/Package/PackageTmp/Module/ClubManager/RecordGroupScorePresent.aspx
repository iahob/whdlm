<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGroupScorePresent.aspx.cs" Inherits="Game.Web.Module.ClubManager.RecordGroupScorePresent" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="28">
                <ul>
                    <li class="tab2" onclick="Redirect('RecordGroupScoreChangeList.aspx')">勋章记录</li>
                    <li class="tab1" >操作记录</li>
                    <li class="tab2" onclick="Redirect('RecordUserScoreChangeList.aspx')">用户流水</li>
                    <li class="tab2" onclick="Redirect('RecordBoxScoreList.aspx')">提取记录</li>
                </ul>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="ddlSearchType" runat="server">
                    <asp:ListItem Value="1">大联盟ID</asp:ListItem>
                    <asp:ListItem Value="2">操作者游戏ID</asp:ListItem>
                    <asp:ListItem Value="3">玩家游戏ID</asp:ListItem>
                </asp:DropDownList>
                日期：
            ...
            <asp:Repeater ID="rptInsure" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Eval( "PresentNickName" ) %>
                        </td>
                        <td>
                            <%# Eval( "ReceiveGameID" ) %>
                        </td>
                        <td>
                            <%# Eval( "ReceiveNickName" ) %>
                        </td>
                        <td>
                            <%# GetGroupScorePresentType(Convert.ToInt32(Eval( "ChangeType" )))  %>
                        </td>
                        <td>
                            <%# Eval( "CurScore" ) %>
                        </td>
