        ...
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="ddlGlobalShareInfo" runat="server">
                    ...
                    <asp:ListItem Text="新竣付通微信充值" Value="401"></asp:ListItem>
                    <asp:ListItem Text="新竣付通支付宝充值" Value="402"></asp:ListItem>
                    <asp:ListItem Text="新竣付通云闪付充值" Value="403"></asp:ListItem>
            ...
            <asp:Repeater ID="rptShareInfo" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# GetPayStatus(Convert.ToInt32(Eval("OrderStatus")),"RecordPayDiamondChange.aspx?param="+Eval("OrderID"),"RecordChange_"+Eval("OrderID"),500,246) %>
                        </td>
                        <td>
                            <%# Eval("OrderAddress")%>
                        </td>
