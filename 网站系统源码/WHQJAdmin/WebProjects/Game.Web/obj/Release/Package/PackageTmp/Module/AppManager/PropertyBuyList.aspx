<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PropertyBuyList.aspx.cs" Inherits="Game.Web.Module.AppManager.PropertyBuyList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                      ...
                      <td>
                        <%# Eval( "BuyNum" ).ToString( )%>
                      </td>
                      <td>
                        <%# Eval( "Currency" ).ToString( )%>
                      </td>
                      <td>
                        <%# Eval( "BeforeCurrency" ).ToString( )%>
                      </td>
                      <td>
                        <%# Eval( "ClinetIP" ).ToString( )%>
                      </td>
                    </tr>
                </ItemTemplate>
