...
namespace Game.Web.Module.Diamond
{
    public partial class RecordPersonRoom : AdminPage
    {
        ...
        {
            PagerSet pagerSet = FacadeManage.aidePlatformFacade.GetList(StreamCreateTableFeeInfo.Tablename, SearchItems, Orderby, anpNews.CurrentPageIndex, anpNews.PageSize);
