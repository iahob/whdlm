...
{
    public partial class RecordUserScoreChangeList : AdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ddlChangeType.DataSource = GetSerialTypeList(typeof(GroupUserScoreType));
        ...
        private void RecordInsureDataBind()
        {
            ...
            PagerSet pagerSet = FacadeManage.aideGroupFacade.GetPageGroupUserScoreChangeList(condition.ToString(), Orderby, anpNews.CurrentPageIndex, anpNews.PageSize);
