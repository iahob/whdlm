<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyMaxMemeberCount.aspx.cs" Inherits="Game.Web.Module.ClubManager.ModifyMaxMemeberCount" %>
...
<form runat="server" id="form1">
  ...
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2" style="height: 99px;">
    <tr>
      ...
      <td>
        <asp:TextBox ID="txtMaxMemeberCount" runat="server" CssClass="text wd4" ></asp:TextBox>
        <span class="hong">*</span>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="请输入最大人数" Display="Dynamic" ControlToValidate="txtMaxMemeberCount" ForeColor="Red"></asp:RequiredFieldValidator>
