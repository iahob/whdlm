<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGroupScoreChangeList.aspx.cs" Inherits="Game.Web.Module.ClubManager.RecordGroupScoreChangeList" %>
            ...
            <asp:Repeater ID="rptInsure" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# GetGroupScoreType(Convert.ToInt32(Eval( "ChangeType" )))  %>
                        </td>
                        <td>
                            <%# Eval( "BeforeScore" ) %>
                        </td>
