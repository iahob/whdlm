<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordUserScoreChangeList.aspx.cs" Inherits="Game.Web.Module.ClubManager.RecordUserScoreChangeList" %>
        ...
        <tr>
            <td height="28">
                <ul>
                    ...
                    <li class="tab2" onclick="Redirect('RecordGroupScorePresent.aspx')">操作记录</li>
                    <li class="tab1" >用户流水</li>
            ...
            <asp:Repeater ID="rptInsure" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# GetGroupUserScoreType(Convert.ToInt32(Eval( "ChangeType" )))  %>
                        </td>
                        <td>
                            <%# Eval( "BeforeScore" ) %>
                        </td>
