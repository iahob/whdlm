<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGrantAwardTicketList.aspx.cs" Inherits="Game.Web.Module.AccountManager.RecordGrantAwardTicketList" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="28">
                <ul>
                    <li class="tab2" onclick="Redirect('RecordGrantGoldList.aspx')">金币记录</li>
                    <li class="tab2" onclick="Redirect('RecordGrantDiamondList.aspx')">钻石记录</li>
                     <li class="tab1">奖券记录</li>
                </ul>
            </td>
        </tr>
    </table>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Convert.ToInt32(Eval( "CurAwardTicket" ))+Convert.ToInt32(Eval( "AddAwardTicket" )) %>
                        </td>
                        <td>
