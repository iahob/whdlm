    ...
    public partial class ConfineMachineInfo : AdminPage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                machine.MachineSerial = CtrlHelper.GetTextAndFilter(txtString);
            }

            machine.EnjoinLogon = ckbEnjoinLogon.Checked;
            machine.EnjoinRegister = ckbEnjoinRegister.Checked;
            machine.EnjoinOverDate = string.IsNullOrEmpty(CtrlHelper.GetTextAndFilter(txtEnjoinOverDate)) ? Convert.ToDateTime("1900-01-01") : Convert.ToDateTime(CtrlHelper.GetTextAndFilter(txtEnjoinOverDate));
            machine.CollectNote = CtrlHelper.GetTextAndFilter(txtCollectNote);
            int result = 0;
