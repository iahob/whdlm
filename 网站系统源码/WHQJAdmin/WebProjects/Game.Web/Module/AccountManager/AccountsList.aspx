        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
            <tr>
                <td height="39" class="titleOpBg">
                    ...
                    <input class="btnLine" type="button" />
                    <asp:Button ID="Button1" runat="server" Text="批量设置调试权限" CssClass="btn" Width="125px" OnClick="btnSetDeBug_Click" OnClientClick="return deleteop()" />
                    <asp:Button ID="Button2" runat="server" Text="批量取消调试权限" CssClass="btn" Width="125px" OnClick="benCancleDeBug_Click" OnClientClick="return deleteop()" />
                ...
                <asp:Repeater ID="rptDataList" runat="server">
                    <ItemTemplate>
                        <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                            ...
                            <td>
                                <%# (Convert.ToInt32(Eval( "UserRight" ).ToString( )) & 536870912)==0?"无":"有"  %>
                            </td>
                            <td>
