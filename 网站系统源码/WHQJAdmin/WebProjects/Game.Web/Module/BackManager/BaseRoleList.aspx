            ...
            <asp:Repeater ID="rptRole" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# (int)Eval("RoleID") == 1 ? "" : "<a class='l' href='BaseRoleInfo.aspx?cmd=edit&param=" + Eval("RoleID") + "'>编辑</a>&nbsp;<a class='l' href='BaseRolePermission.aspx?cmd=edit&param=" + Eval("RoleID") + "'>配置权限</a> "%>
                        </td>
                        <td>
                            <%# Eval("RoleName")%>
                        </td>
