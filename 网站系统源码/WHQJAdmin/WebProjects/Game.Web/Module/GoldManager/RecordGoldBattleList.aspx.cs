...
{
    public partial class RecordGoldBattleList : AdminPage
    {
        ...
        private void BindData()
        {
            ...
            condition.AppendFormat(" AND PlayMode=1");

            PagerSet pagerSet = FacadeManage.aidePlatformFacade.GetPageGoldBattleList(condition.ToString(), Orderby, 
