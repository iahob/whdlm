...
namespace Game.Web.Module.GoldManager
{
    public partial class AccountsGoldList : AdminPage
    {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideTreasureFacade.GetList(GameScoreInfo.Tablename, SearchItems, Orderby, anpPage.CurrentPageIndex, anpPage.PageSize);
