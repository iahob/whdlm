<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordGoldBattleList.aspx.cs" Inherits="Game.Web.Module.GoldManager.RecordGoldBattleList" %>
                    ...
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <a class="l" href="javascript:void(0)" 
                                onclick="javascript:openWindowOwn('RecordGoldBattleInfo.aspx?rid=<%#Eval("RoomID") %>&uid=<%#Eval("UserID") %>&mode=<%#Eval("PlayMode") %>&time=<%# Convert.ToDateTime(Eval("CreateDate")).ToString("yyyy-MM-dd HH:mm:ss") %>','RoomScore',600,500);">查看战绩</a>
                        </td>
                    </tr>
                </ItemTemplate>
