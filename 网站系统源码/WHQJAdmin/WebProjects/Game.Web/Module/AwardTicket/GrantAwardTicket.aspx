<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrantAwardTicket.aspx.cs" Inherits="Game.Web.Module.AwardTicket.GrantAwardTicket" %>
...
<body>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="listBg2" style="height:136px;">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAwardTicket" runat="server" CssClass="text wd4" MaxLength="7"></asp:TextBox>
                <span class="hong">*</span>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="请输入赠送奖券" Display="Dynamic" ControlToValidate="txtAwardTicket" ForeColor="Red"></asp:RequiredFieldValidator>
               <%-- <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="赠送奖券格式不正确" Display="Dynamic" ControlToValidate="txtAwardTicket" ForeColor="Red" ValidationExpression="^\d{1,8}$"></asp:RegularExpressionValidator>--%>
            </td>
        </tr>
        <tr>
            <td class="listTdLeft">
