<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExchangeAwardTicketList.aspx.cs" Inherits="Game.Web.Module.AwardTicket.ExchangeAwardTicketList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%#-Convert.ToInt32( Eval( "ChangeAwardTicket" ))%>
                        </td> 
