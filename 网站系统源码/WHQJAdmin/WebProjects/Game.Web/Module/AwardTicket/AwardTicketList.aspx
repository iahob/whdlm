<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AwardTicketList.aspx.cs" Inherits="Game.Web.Module.AwardTicket.AwardTicketList" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="titleQueBg" style="margin-bottom:3px;">
        <tr>
            ...
            <td>
                ...
                <input type="button" value="奖券前50名" class="btn" style="width:85px;" onclick="openWindowOwn('TopAwardTicket.aspx', '', 850, 600);" />
                <input type="button" value="赠送奖券" class="btn" style="width:85px;" onclick="openWindowOwn('GrantAwardTicket.aspx', '', 600, 270);" />
            </td>
        </tr>
    </table>
    <div id="content">
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Eval( "AwardTicket" ).ToString( )%>
                        </td>
                        <td>
                            <a class="l" href="javascript:void(0)" onclick="javascript:openWindowOwn('GrantAwardTicket.aspx?param=<%#Eval("UserID").ToString() %>','GrantAwardTicket',600,240);">赠送奖券</a>
                        </td>  
                    </tr>
                </ItemTemplate>
