<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecordAwardTicketSerialList.aspx.cs" Inherits="Game.Web.Module.AwardTicket.RecordAwardTicketSerialList" %>
            ...
            <asp:Repeater ID="rptDataList" runat="server">
                <ItemTemplate>
                    <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        ...
                        <td>
                            <%# Eval( "ChangeAwardTicket" )%>
                        </td> 
                        <td>
                            <%#GetAwardTicketSerialType(Convert.ToInt32( Eval( "TypeID" )))%>
                        </td>
                    </tr>
                </ItemTemplate>
