<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyPay.aspx.cs" Inherits="Game.Web.Module.DataStatistics.DailyPay" %>
...
<body>
    ...
    <h2 style="text-align: center;margin-bottom: 5px;">平台每日充值</h2>
    <div id="content">
    </div>
    ...
    <script type="text/javascript">
        ...
        chart.line().position('time*amount').color('type', ['#ff7f0e']).shape('smooth').size(2);
        chart.render();
        ...
        function loadData() {
            $.ajax({
                type: "GET",
                url: "/Tools/Operating.ashx?action=getplatformpay",
