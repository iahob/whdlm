<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShareLogList.aspx.cs" Inherits="Game.Web.Module.AppManager.ShareLogList" %>
...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
            <td height="28">
                <ul>
                    <li class="tab2" onclick="Redirect('ShareConfigList.aspx')">每日分享配置</li>
                    <li class="tab1">分享记录</li>
