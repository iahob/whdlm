<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="H5GameKindItemList.aspx.cs" Inherits="Game.Web.Module.AppManager.H5GameKindItemList" %>
        ...
        <tr>
            <td height="28">
                <ul>
                    ...
                    <li class="tab2" onclick="Redirect('U3DGameKindItemList.aspx')">U3D游戏列表</li>
                    <li class="tab1">H5游戏列表</li>
                </ul>
            </td>
        </tr>
    </table>
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="39" class="titleOpBg">
                <input type="button" value="新增" class="btn wd1" onclick="Redirect('H5GameKindItemInfo.aspx?cmd=add')" />
            ...
            <asp:Repeater ID="rptMobileKindItem" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">
                        ...
                        <td>                             
                            <a class="l" href="H5GameKindItemInfo.aspx?cmd=edit&param=<%#Eval("KindID") %>">编辑</a>              
                        </td>          
                        <td><%# Eval("KindID")%></td>    
                        <td><%# Eval("KindName")%></td>       
