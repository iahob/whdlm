...
namespace Game.Web.Module.AppManager
{
    public partial class SpreadReturnConfigList : AdminPage
    {
        ...
        {
            PagerSet pagerSet = FacadeManage.aideTreasureFacade.GetList(SpreadReturnConfig.Tablename, "", " ORDER BY SpreadLevel ASC", anpNews.CurrentPageIndex, anpNews.PageSize);
