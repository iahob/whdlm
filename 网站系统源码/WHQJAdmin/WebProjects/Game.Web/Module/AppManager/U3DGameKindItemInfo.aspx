<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="U3DGameKindItemInfo.aspx.cs" Inherits="Game.Web.Module.AppManager.U3DGameKindItemInfo" %>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td class="titleOpBg Lpd10">
                <input type="button" value="返回" class="btn wd1" onclick="Redirect('U3DGameKindItemList.aspx')" />                           
