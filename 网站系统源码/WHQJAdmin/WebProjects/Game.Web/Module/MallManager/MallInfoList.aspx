        ...
        <div id="content">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
                <tr align="center" class="bold">
                    ...
                    <td class="listTitle2">商品价格（奖券）</td>
                    <td class="listTitle2">商品库存</td>
                    <td class="listTitle2">游戏币值</td>
                    <td class="listTitle2">钻石值</td>
                       ...
                       <tr align="center" class="list" onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#caebfc';this.style.cursor='default';"
                        onmouseout="this.style.backgroundColor=currentcolor">
                            ...
                            <td><%# Eval("AwardName")%></td>
                             <td><%#  Convert.ToInt32(Eval( "AwardType" ))==1?"游戏币":Convert.ToInt32(Eval( "AwardType" ))==2?"日常":Convert.ToInt32(Eval( "AwardType" ))==3?"数码":"卡券" %></td>
