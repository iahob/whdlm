...
{
    public partial class AIWeightInRatioList : AdminPage
    {
        /// <summary>
        /// 页面加载
        /// </summary>
        ...
        {
            PagerSet pagerSet = FacadeManage.aidePlatformFacade.GetList(AIWeightInRatio.Tablename, SearchItems, Orderby, anpNews.CurrentPageIndex, anpNews.PageSize);
