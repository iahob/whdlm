<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupGameControlSubList.aspx.cs" Inherits="Game.Web.Module.DebugManager.GroupGameControlSubList" %>
      ...
      <asp:Repeater ID="rptDataList" runat="server">
        <ItemTemplate>
          <tr align="center" class="list" onmouseover="currentcolor = this.style.backgroundColor;this.style.backgroundColor = '#caebfc';this.style.cursor = 'default';"
            ...
            <td>
              <%# Eval("ConfigSysStorage") %>, <%# Eval("ConfigPlayerStorage") %>
            </td>
            <td>
              <%# Eval("ConfigParameterK") %>%
            </td>
            <td>
              <%# Eval("CurResetCount") %>
            </td>
            <td>
              <a href="javascript:;" class="l" onclick="openWindowOwn('GroupGameControlSubInfo.aspx?groupid=<%# Eval("GroupID") %>&kindid=<%# Eval("KindID") %>', '', 800, 620);">查看修改</a> 
            </td>
          </tr>
        </ItemTemplate>
