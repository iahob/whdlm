<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AITimeChangeList.aspx.cs" Inherits="Game.Web.Module.DebugManager.AITimeChangeList" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="title">
        <tr>
            ...
            <td width="1232" height="25" valign="top" align="left">你当前位置：调试系统 - AI设置 - AI人数调整</td>
        </tr>
    </table>
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
        <tr>
          <td height="28">
            <ul>
              <li class="tab1">AI人数调整</li>
              <li class="tab2" onclick="Redirect('AIWeightInRatioList.aspx')">进入房间权重</li>
              <li class="tab2" onclick="Redirect('AIWeightOutRatioList.aspx')">离开联盟权重</li>
            </ul>
          </td>
        </tr>
      </table>
    ...
    <div id="content">
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box" id="list">
            <tr align="center" class="bold">
                ...
                <td class="listTitle2">时间节点(点钟)</td>
                <td class="listTitle2">AI数量</td>  
            </tr>
            <asp:Repeater ID="rptIssue" runat="server">
                <ItemTemplate>
                    ...
                    onmouseout="this.style.backgroundColor=currentcolor">    
                        <td>                             
                            <a class="l" href="AITimeChangeInfo.aspx?param=<%#Eval("AITime") %>">编辑</a>              
                        </td>                
                        <td><%# Eval("AITime") %></td>
                        <td><%# Eval("AICount") %></td>
