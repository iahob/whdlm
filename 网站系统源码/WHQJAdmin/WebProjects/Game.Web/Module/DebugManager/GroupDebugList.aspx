<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupDebugList.aspx.cs" Inherits="Game.Web.Module.DebugManager.GroupDebugList" %>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tmg7">
    <tr>
      <td height="39" class="titleOpBg">
        <input type="button" onclick="Redirect('GroupDebugList.aspx');" class="btn wd1" value="刷新"/>
      </td>
    </tr>
  </table>
  <div id="content">
      ...
      <asp:Repeater ID="rptDataList" runat="server">
        <ItemTemplate>
          <tr align="center" class="list" onmouseover="currentcolor = this.style.backgroundColor;this.style.backgroundColor = '#caebfc';this.style.cursor = 'default';"
            ...
            <td>
              <a href="GroupDebugUserList.aspx?groupId=<%# Eval("GroupID") %>" class="l">配置详情</a>
            </td>
          </tr>
        </ItemTemplate>
