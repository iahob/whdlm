...
namespace Game.Web.UI
{
    ...
    public abstract partial class AdminPage : Page
    {
        ...
        /// <param name="typeid">类型标识</param>
        /// <returns></returns>
        protected string GetGroupScoreType(int typeid)
        {
            return EnumHelper.GetDesc(typeof(GroupScoreType), typeid);
        }
        ...
        /// <param name="typeid">类型标识</param>
        /// <returns></returns>
        protected string GetGroupScorePresentType(int typeid)
        {
            return EnumHelper.GetDesc(typeof(GroupScorePresentType), typeid);
        }
        ...
        /// <param name="typeid">类型标识</param>
        /// <returns></returns>
        protected string GetGroupUserScoreType(int typeid)
        {
            return EnumHelper.GetDesc(typeof(GroupUserScoreType), typeid);
        }
        ...
        {
            return FacadeManage.aideGroupFacade.GetGroupInfo(groupid)?.GroupName ?? "";
        }

        /// <summary>
        /// 获取大联盟身份
        /// </summary>
        /// <param name="MemberRight">身份标识</param>
        /// <returns></returns>
        public string GetGroupIdentity(int MemberRight)
        {
            string rValue = "";
            switch (MemberRight)
            {
