...
namespace Game.Web.Helper
{
    ...
    public sealed class AlipayRSA
    {
        ...
        public static bool RSACheckV1(IDictionary<string, string> parameters, string publicKeyPem, string charset, string signtype)
        {
            ...
            return RSACheckContent(signContent, sign, publicKeyPem, charset, signtype, false);
        }
