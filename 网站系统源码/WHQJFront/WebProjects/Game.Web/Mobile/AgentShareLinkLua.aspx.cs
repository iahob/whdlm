...
{
    public partial class AgentShareLinkLua : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (state == "already")
            {
                ...
                MobileQrcode = Fetch.GetQrCode("http://" + Request.Url.Authority + "/Mobile/AgentShareLinkLua.aspx?r=" + random.Next(1000, 9999) + "&g=" + gameid, 312);
            }
            else
            {
                ...
                Response.Redirect("/Mobile/WxRegister.aspx?t=84&g=" + gameid + (!string.IsNullOrEmpty(type) ? "&y=" + type : ""));
            }
