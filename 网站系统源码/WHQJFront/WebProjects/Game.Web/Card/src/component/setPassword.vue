    ...
    <form>
     <div class="ui-panel">
       <div class="ui-form-item">
         <label class="ui-form-item-label">安全密码：</label>
         <input type="password" class="ui-value" placeholder="请输入安全密码" v-model="password">
       </div>
       <div class="ui-form-item">
         <label class="ui-form-item-label">确认密码：</label>
         <input type="password" class="ui-value" placeholder="请输入确认密码" v-model="repeatPassword">
       </div>
     </div>
    ...
    validate: function() {
      switch (true) {
        case !this.password:
          ...
          break
        case !(this.repeatPassword == this.password):
